...
#include "std_srvs/srv/trigger__rosidl_typesupport_fastrtps_c.h"
...
{
  return max_serialized_size_std_srvs__srv__Trigger_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_std_srvs__srv__Trigger_Response(
    full_bounded, 0);
}
