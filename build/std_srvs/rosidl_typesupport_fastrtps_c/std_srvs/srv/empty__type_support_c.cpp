...
#include "std_srvs/srv/empty__rosidl_typesupport_fastrtps_c.h"
...
{
  return max_serialized_size_std_srvs__srv__Empty_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_std_srvs__srv__Empty_Response(
    full_bounded, 0);
}
