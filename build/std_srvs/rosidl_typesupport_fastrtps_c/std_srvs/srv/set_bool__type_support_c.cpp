...
#include "std_srvs/srv/set_bool__rosidl_typesupport_fastrtps_c.h"
...
{
  return max_serialized_size_std_srvs__srv__SetBool_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_std_srvs__srv__SetBool_Response(
    full_bounded, 0);
}
