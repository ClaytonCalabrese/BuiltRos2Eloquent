...
#include "lifecycle_msgs/msg/transition__rosidl_typesupport_fastrtps_c.h"
...
static size_t _Transition__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_lifecycle_msgs__msg__Transition(
    full_bounded, 0);
}
