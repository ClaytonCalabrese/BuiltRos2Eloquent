...
#include "lifecycle_msgs/srv/get_available_transitions__rosidl_typesupport_fastrtps_c.h"
...
{
  return max_serialized_size_lifecycle_msgs__srv__GetAvailableTransitions_Request(
    full_bounded, 0);
}
...
#include "lifecycle_msgs/msg/transition_description__functions.h"  // available_transitions
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: available_transitions
  {
    ...
    if (!lifecycle_msgs__msg__TransitionDescription__Sequence__init(&ros_message->available_transitions, size)) {
      return "failed to create array for field 'available_transitions'";
    }
    auto array_ptr = ros_message->available_transitions.data;
    for (size_t i = 0; i < size; ++i) {
...
{
  return max_serialized_size_lifecycle_msgs__srv__GetAvailableTransitions_Response(
    full_bounded, 0);
}
