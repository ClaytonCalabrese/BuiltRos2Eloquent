...
#include "lifecycle_msgs/srv/get_available_states__rosidl_typesupport_fastrtps_c.h"
...
static size_t _GetAvailableStates_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_lifecycle_msgs__srv__GetAvailableStates_Request(
    full_bounded, 0);
}
...
#include "lifecycle_msgs/msg/state__functions.h"  // available_states
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: available_states
  {
    ...
    if (!lifecycle_msgs__msg__State__Sequence__init(&ros_message->available_states, size)) {
      return "failed to create array for field 'available_states'";
    }
    auto array_ptr = ros_message->available_states.data;
    for (size_t i = 0; i < size; ++i) {
...
static size_t _GetAvailableStates_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_lifecycle_msgs__srv__GetAvailableStates_Response(
    full_bounded, 0);
}
