...
#include "lifecycle_msgs/srv/get_state__rosidl_typesupport_fastrtps_c.h"
...
{
  return max_serialized_size_lifecycle_msgs__srv__GetState_Request(
    full_bounded, 0);
}
...
#include "lifecycle_msgs/msg/state__functions.h"  // current_state
...
{
  return max_serialized_size_lifecycle_msgs__srv__GetState_Response(
    full_bounded, 0);
}
