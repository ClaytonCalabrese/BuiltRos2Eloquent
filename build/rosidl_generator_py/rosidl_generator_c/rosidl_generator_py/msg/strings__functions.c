...
{
  rosidl_generator_py__msg__Strings * msg = (rosidl_generator_py__msg__Strings *)malloc(sizeof(rosidl_generator_py__msg__Strings));
  if (!msg) {
    return NULL;
  }
...
rosidl_generator_py__msg__Strings__Sequence__init(rosidl_generator_py__msg__Strings__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosidl_generator_py__msg__Strings *)calloc(size, sizeof(rosidl_generator_py__msg__Strings));
    if (!data) {
      return false;
    }
...
{
  rosidl_generator_py__msg__Strings__Sequence * array = (rosidl_generator_py__msg__Strings__Sequence *)malloc(sizeof(rosidl_generator_py__msg__Strings__Sequence));
  if (!array) {
    return NULL;
  }
