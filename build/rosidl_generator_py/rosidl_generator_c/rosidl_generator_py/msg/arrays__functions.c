...
{
  rosidl_generator_py__msg__Arrays * msg = (rosidl_generator_py__msg__Arrays *)malloc(sizeof(rosidl_generator_py__msg__Arrays));
  if (!msg) {
    return NULL;
  }
...
rosidl_generator_py__msg__Arrays__Sequence__init(rosidl_generator_py__msg__Arrays__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosidl_generator_py__msg__Arrays *)calloc(size, sizeof(rosidl_generator_py__msg__Arrays));
    if (!data) {
      return false;
    }
...
{
  rosidl_generator_py__msg__Arrays__Sequence * array = (rosidl_generator_py__msg__Arrays__Sequence *)malloc(sizeof(rosidl_generator_py__msg__Arrays__Sequence));
  if (!array) {
    return NULL;
  }
