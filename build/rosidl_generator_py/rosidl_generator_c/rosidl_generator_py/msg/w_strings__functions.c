...
{
  rosidl_generator_py__msg__WStrings * msg = (rosidl_generator_py__msg__WStrings *)malloc(sizeof(rosidl_generator_py__msg__WStrings));
  if (!msg) {
    return NULL;
  }
...
rosidl_generator_py__msg__WStrings__Sequence__init(rosidl_generator_py__msg__WStrings__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosidl_generator_py__msg__WStrings *)calloc(size, sizeof(rosidl_generator_py__msg__WStrings));
    if (!data) {
      return false;
    }
...
{
  rosidl_generator_py__msg__WStrings__Sequence * array = (rosidl_generator_py__msg__WStrings__Sequence *)malloc(sizeof(rosidl_generator_py__msg__WStrings__Sequence));
  if (!array) {
    return NULL;
  }
