...
{
  new (message_memory) rosidl_generator_py::msg::MultiNested(_init);
}

void MultiNested_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rosidl_generator_py::msg::MultiNested *>(message_memory);
...
{
  const auto & member =
    *reinterpret_cast<const std::array<rosidl_generator_py::msg::Arrays, 3> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::array<rosidl_generator_py::msg::Arrays, 3> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & member =
    *reinterpret_cast<const std::array<rosidl_generator_py::msg::BoundedSequences, 3> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::array<rosidl_generator_py::msg::BoundedSequences, 3> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & member =
    *reinterpret_cast<const std::array<rosidl_generator_py::msg::UnboundedSequences, 3> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::array<rosidl_generator_py::msg::UnboundedSequences, 3> *>(untyped_member);
  return &member[index];
}

size_t size_function__MultiNested__bounded_sequence_of_arrays(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<rosidl_generator_py::msg::Arrays> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<rosidl_generator_py::msg::Arrays> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<rosidl_generator_py::msg::Arrays> *>(untyped_member);
  return &member[index];
}
...
{
  const auto * member = reinterpret_cast<const std::vector<rosidl_generator_py::msg::BoundedSequences> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<rosidl_generator_py::msg::BoundedSequences> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<rosidl_generator_py::msg::BoundedSequences> *>(untyped_member);
  return &member[index];
}
...
{
  const auto * member = reinterpret_cast<const std::vector<rosidl_generator_py::msg::UnboundedSequences> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<rosidl_generator_py::msg::UnboundedSequences> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<rosidl_generator_py::msg::UnboundedSequences> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MultiNested_message_member_array[9] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rosidl_generator_py::msg::Arrays>(),  // members of sub message
    true,  // is array
    3,  // array size
    false,  // is upper bound
    offsetof(rosidl_generator_py::msg::MultiNested, array_of_arrays),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rosidl_generator_py::msg::BoundedSequences>(),  // members of sub message
    true,  // is array
    3,  // array size
    false,  // is upper bound
    offsetof(rosidl_generator_py::msg::MultiNested, array_of_bounded_sequences),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rosidl_generator_py::msg::UnboundedSequences>(),  // members of sub message
    true,  // is array
    3,  // array size
    false,  // is upper bound
    offsetof(rosidl_generator_py::msg::MultiNested, array_of_unbounded_sequences),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    true,  // is upper bound
    offsetof(rosidl_generator_py::msg::MultiNested, bounded_sequence_of_arrays),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    true,  // is upper bound
    offsetof(rosidl_generator_py::msg::MultiNested, bounded_sequence_of_bounded_sequences),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    true,  // is upper bound
    offsetof(rosidl_generator_py::msg::MultiNested, bounded_sequence_of_unbounded_sequences),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosidl_generator_py::msg::MultiNested, unbounded_sequence_of_arrays),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosidl_generator_py::msg::MultiNested, unbounded_sequence_of_bounded_sequences),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosidl_generator_py::msg::MultiNested, unbounded_sequence_of_unbounded_sequences),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MultiNested_message_members = {
  ...
  9,  // number of fields
  sizeof(rosidl_generator_py::msg::MultiNested),
...
get_message_type_support_handle<rosidl_generator_py::msg::MultiNested>()
{
  return &::rosidl_generator_py::msg::rosidl_typesupport_introspection_cpp::MultiNested_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosidl_generator_py, msg, MultiNested)() {
  return &::rosidl_generator_py::msg::rosidl_typesupport_introspection_cpp::MultiNested_message_type_support_handle;
}
