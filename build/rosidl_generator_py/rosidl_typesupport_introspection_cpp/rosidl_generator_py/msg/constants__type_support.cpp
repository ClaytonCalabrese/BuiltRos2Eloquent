...
{
  new (message_memory) rosidl_generator_py::msg::Constants(_init);
}

void Constants_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rosidl_generator_py::msg::Constants *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Constants_message_member_array[1] = {
  {
    ...
    offsetof(rosidl_generator_py::msg::Constants, structure_needs_at_least_one_member),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Constants_message_members = {
  ...
  1,  // number of fields
  sizeof(rosidl_generator_py::msg::Constants),
...
{
  return &::rosidl_generator_py::msg::rosidl_typesupport_introspection_cpp::Constants_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosidl_generator_py, msg, Constants)() {
  return &::rosidl_generator_py::msg::rosidl_typesupport_introspection_cpp::Constants_message_type_support_handle;
}
