...
#include "rosidl_generator_py/msg/strings__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rosidl_generator_py::msg::Strings & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rosidl_generator_py::msg::Strings & ros_message)
{
  // Member: string_value
  cdr >> ros_message.string_value;
...
{
  auto typed_message =
    static_cast<const rosidl_generator_py::msg::Strings *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rosidl_generator_py::msg::Strings *>(
    untyped_ros_message);
...
{
  return &rosidl_generator_py::msg::typesupport_fastrtps_cpp::_Strings__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rosidl_generator_py, msg, Strings)() {
  return &rosidl_generator_py::msg::typesupport_fastrtps_cpp::_Strings__handle;
}
