...
#include "rosidl_generator_py/msg/unbounded_sequences__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const rosidl_generator_py::msg::BasicTypes &,
...
{
bool cdr_serialize(
  const rosidl_generator_py::msg::Constants &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const rosidl_generator_py::msg::Defaults &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const rosidl_generator_py::msg::UnboundedSequences & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: basic_types_values
  {
    ...
    for (size_t i = 0; i < size; i++) {
      rosidl_generator_py::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rosidl_generator_py::msg::UnboundedSequences & ros_message)
{
  // Member: bool_values
  {
    cdr >> ros_message.bool_values;
  ...
  // Member: basic_types_values
  {
    ...
    for (size_t i = 0; i < size; i++) {
      rosidl_generator_py::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: basic_types_values
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        rosidl_generator_py::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: basic_types_values
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        rosidl_generator_py::msg::typesupport_fastrtps_cpp::max_serialized_size_BasicTypes(
  ...
  // Member: constants_values
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        rosidl_generator_py::msg::typesupport_fastrtps_cpp::max_serialized_size_Constants(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: defaults_values
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        rosidl_generator_py::msg::typesupport_fastrtps_cpp::max_serialized_size_Defaults(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const rosidl_generator_py::msg::UnboundedSequences *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rosidl_generator_py::msg::UnboundedSequences *>(
    untyped_ros_message);
...
{
  return &rosidl_generator_py::msg::typesupport_fastrtps_cpp::_UnboundedSequences__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rosidl_generator_py, msg, UnboundedSequences)() {
  return &rosidl_generator_py::msg::typesupport_fastrtps_cpp::_UnboundedSequences__handle;
}
