...
#include "rosidl_generator_py/msg/w_strings__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rosidl_generator_py::msg::WStrings & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rosidl_generator_py::msg::WStrings & ros_message)
{
  // Member: wstring_value
  {
    std::wstring wstr;
...
{
  auto typed_message =
    static_cast<const rosidl_generator_py::msg::WStrings *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rosidl_generator_py::msg::WStrings *>(
    untyped_ros_message);
...
{
  return &rosidl_generator_py::msg::typesupport_fastrtps_cpp::_WStrings__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rosidl_generator_py, msg, WStrings)() {
  return &rosidl_generator_py::msg::typesupport_fastrtps_cpp::_WStrings__handle;
}
