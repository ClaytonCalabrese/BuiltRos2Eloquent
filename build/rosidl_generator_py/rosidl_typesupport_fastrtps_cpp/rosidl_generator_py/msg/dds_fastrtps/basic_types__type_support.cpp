...
#include "rosidl_generator_py/msg/basic_types__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rosidl_generator_py::msg::BasicTypes & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rosidl_generator_py::msg::BasicTypes & ros_message)
{
  // Member: bool_value
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const rosidl_generator_py::msg::BasicTypes *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rosidl_generator_py::msg::BasicTypes *>(
    untyped_ros_message);
...
static size_t _BasicTypes__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_BasicTypes(full_bounded, 0);
}
...
{
  return &rosidl_generator_py::msg::typesupport_fastrtps_cpp::_BasicTypes__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rosidl_generator_py, msg, BasicTypes)() {
  return &rosidl_generator_py::msg::typesupport_fastrtps_cpp::_BasicTypes__handle;
}
