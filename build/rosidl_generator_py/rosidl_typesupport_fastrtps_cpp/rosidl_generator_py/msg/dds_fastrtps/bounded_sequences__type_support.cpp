...
#include "rosidl_generator_py/msg/bounded_sequences__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rosidl_generator_py::msg::BoundedSequences & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rosidl_generator_py::msg::BoundedSequences & ros_message)
{
  // Member: bool_values
  {
    uint32_t cdrSize;
...
{
  auto typed_message =
    static_cast<const rosidl_generator_py::msg::BoundedSequences *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rosidl_generator_py::msg::BoundedSequences *>(
    untyped_ros_message);
...
{
  return &rosidl_generator_py::msg::typesupport_fastrtps_cpp::_BoundedSequences__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rosidl_generator_py, msg, BoundedSequences)() {
  return &rosidl_generator_py::msg::typesupport_fastrtps_cpp::_BoundedSequences__handle;
}
