...
#include "rosidl_generator_py/msg/multi_nested__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const rosidl_generator_py::msg::Arrays &,
...
{
bool cdr_serialize(
  const rosidl_generator_py::msg::BoundedSequences &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const rosidl_generator_py::msg::UnboundedSequences &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const rosidl_generator_py::msg::MultiNested & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rosidl_generator_py::msg::MultiNested & ros_message)
{
  // Member: array_of_arrays
  {
    for (size_t i = 0; i < 3; i++) {
  ...
  size_t current_alignment)
{
  ...
  // Member: array_of_arrays
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        rosidl_generator_py::msg::typesupport_fastrtps_cpp::max_serialized_size_Arrays(
  ...
  // Member: array_of_bounded_sequences
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        rosidl_generator_py::msg::typesupport_fastrtps_cpp::max_serialized_size_BoundedSequences(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: array_of_unbounded_sequences
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        rosidl_generator_py::msg::typesupport_fastrtps_cpp::max_serialized_size_UnboundedSequences(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const rosidl_generator_py::msg::MultiNested *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rosidl_generator_py::msg::MultiNested *>(
    untyped_ros_message);
...
{
  return max_serialized_size_MultiNested(full_bounded, 0);
}
...
{
  return &rosidl_generator_py::msg::typesupport_fastrtps_cpp::_MultiNested__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rosidl_generator_py, msg, MultiNested)() {
  return &rosidl_generator_py::msg::typesupport_fastrtps_cpp::_MultiNested__handle;
}
