...
#ifndef ROSIDL_GENERATOR_PY__MSG__BOUNDED_SEQUENCES__STRUCT_HPP_
#define ROSIDL_GENERATOR_PY__MSG__BOUNDED_SEQUENCES__STRUCT_HPP_
...
struct BoundedSequences_
{
  ...
  using _basic_types_values_type =
    rosidl_generator_cpp::BoundedVector<rosidl_generator_py::msg::BasicTypes_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<rosidl_generator_py::msg::BasicTypes_<ContainerAllocator>>::other>;
  _basic_types_values_type basic_types_values;
  using _constants_values_type =
    rosidl_generator_cpp::BoundedVector<rosidl_generator_py::msg::Constants_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<rosidl_generator_py::msg::Constants_<ContainerAllocator>>::other>;
  _constants_values_type constants_values;
  using _defaults_values_type =
    rosidl_generator_cpp::BoundedVector<rosidl_generator_py::msg::Defaults_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<rosidl_generator_py::msg::Defaults_<ContainerAllocator>>::other>;
  ...
  Type & set__basic_types_values(
    const rosidl_generator_cpp::BoundedVector<rosidl_generator_py::msg::BasicTypes_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<rosidl_generator_py::msg::BasicTypes_<ContainerAllocator>>::other> & _arg)
  {
    this->basic_types_values = _arg;
    return *this;
  }
  Type & set__constants_values(
    const rosidl_generator_cpp::BoundedVector<rosidl_generator_py::msg::Constants_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<rosidl_generator_py::msg::Constants_<ContainerAllocator>>::other> & _arg)
  {
    this->constants_values = _arg;
    return *this;
  }
  Type & set__defaults_values(
    const rosidl_generator_cpp::BoundedVector<rosidl_generator_py::msg::Defaults_<ContainerAllocator>, 3, typename ContainerAllocator::template rebind<rosidl_generator_py::msg::Defaults_<ContainerAllocator>>::other> & _arg)
  {
...
#endif  // ROSIDL_GENERATOR_PY__MSG__BOUNDED_SEQUENCES__STRUCT_HPP_
