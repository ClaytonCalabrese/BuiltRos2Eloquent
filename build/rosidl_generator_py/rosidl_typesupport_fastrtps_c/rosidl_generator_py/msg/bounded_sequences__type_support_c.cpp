...
#include "rosidl_generator_py/msg/bounded_sequences__rosidl_typesupport_fastrtps_c.h"
...
{
  return max_serialized_size_rosidl_generator_py__msg__BoundedSequences(
    full_bounded, 0);
}
