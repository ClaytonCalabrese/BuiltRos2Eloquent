...
#include "rosidl_generator_py/msg/unbounded_sequences__rosidl_typesupport_fastrtps_c.h"
...
{
  return max_serialized_size_rosidl_generator_py__msg__UnboundedSequences(
    full_bounded, 0);
}
