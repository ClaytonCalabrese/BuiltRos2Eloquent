...
#include "trajectory_msgs/msg/joint_trajectory_point__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/primitives_sequence.h"  // accelerations, effort, positions, velocities
#include "rosidl_generator_c/primitives_sequence_functions.h"  // accelerations, effort, positions, velocities
  ...
  void * untyped_ros_message)
{
  ...
  _JointTrajectoryPoint__ros_msg_type * ros_message = static_cast<_JointTrajectoryPoint__ros_msg_type *>(untyped_ros_message);
  // Field name: positions
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
    ...
    if (ros_message->positions.data) {
      rosidl_generator_c__double__Sequence__fini(&ros_message->positions);
    }
  ...
  // Field name: velocities
  {
    ...
    if (ros_message->velocities.data) {
      rosidl_generator_c__double__Sequence__fini(&ros_message->velocities);
    }
  ...
  // Field name: accelerations
  {
    ...
    if (ros_message->accelerations.data) {
      rosidl_generator_c__double__Sequence__fini(&ros_message->accelerations);
    }
  ...
  // Field name: effort
  {
    ...
    if (ros_message->effort.data) {
      rosidl_generator_c__double__Sequence__fini(&ros_message->effort);
    }
...
static size_t _JointTrajectoryPoint__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_trajectory_msgs__msg__JointTrajectoryPoint(
    full_bounded, 0);
}
