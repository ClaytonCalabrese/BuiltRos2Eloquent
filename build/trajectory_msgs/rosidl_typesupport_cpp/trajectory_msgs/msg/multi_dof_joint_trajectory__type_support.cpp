...
static const _MultiDOFJointTrajectory_type_support_symbol_names_t _MultiDOFJointTrajectory_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, trajectory_msgs, msg, MultiDOFJointTrajectory)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, trajectory_msgs, msg, MultiDOFJointTrajectory)),
  }
};
...
{
  return &::trajectory_msgs::msg::rosidl_typesupport_cpp::MultiDOFJointTrajectory_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, trajectory_msgs, msg, MultiDOFJointTrajectory)() {
  return get_message_type_support_handle<trajectory_msgs::msg::MultiDOFJointTrajectory>();
}
