...
#ifndef ROSIDL_GENERATOR_C__MSG__ARRAYS__STRUCT_H_
#define ROSIDL_GENERATOR_C__MSG__ARRAYS__STRUCT_H_
...
// Struct defined in msg/Arrays in the package rosidl_generator_c.
typedef struct rosidl_generator_c__msg__Arrays
{
  bool bool_values[3];
  ...
  rosidl_generator_c__msg__BasicTypes basic_types_values[3];
  rosidl_generator_c__msg__Constants constants_values[3];
  rosidl_generator_c__msg__Defaults defaults_values[3];
...
// Struct for a sequence of rosidl_generator_c__msg__Arrays.
typedef struct rosidl_generator_c__msg__Arrays__Sequence
{
  rosidl_generator_c__msg__Arrays * data;
...
#endif  // ROSIDL_GENERATOR_C__MSG__ARRAYS__STRUCT_H_
