...
{
  rosidl_generator_c__msg__Constants__Sequence * array = (rosidl_generator_c__msg__Constants__Sequence *)malloc(sizeof(rosidl_generator_c__msg__Constants__Sequence));
  if (!array) {
    return NULL;
  }
