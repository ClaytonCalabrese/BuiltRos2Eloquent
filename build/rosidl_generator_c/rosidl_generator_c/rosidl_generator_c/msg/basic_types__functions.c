...
{
  rosidl_generator_c__msg__BasicTypes * msg = (rosidl_generator_c__msg__BasicTypes *)malloc(sizeof(rosidl_generator_c__msg__BasicTypes));
  if (!msg) {
    return NULL;
  }
...
rosidl_generator_c__msg__BasicTypes__Sequence__init(rosidl_generator_c__msg__BasicTypes__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosidl_generator_c__msg__BasicTypes *)calloc(size, sizeof(rosidl_generator_c__msg__BasicTypes));
    if (!data) {
      return false;
    }
...
{
  rosidl_generator_c__msg__BasicTypes__Sequence * array = (rosidl_generator_c__msg__BasicTypes__Sequence *)malloc(sizeof(rosidl_generator_c__msg__BasicTypes__Sequence));
  if (!array) {
    return NULL;
  }
