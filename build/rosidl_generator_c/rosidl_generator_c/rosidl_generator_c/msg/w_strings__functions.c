...
#include "rosidl_generator_c/msg/w_strings__functions.h"
...
rosidl_generator_c__msg__WStrings__init(rosidl_generator_c__msg__WStrings * msg)
{
  ...
  if (!rosidl_generator_c__U16String__init(&msg->wstring_value)) {
    rosidl_generator_c__msg__WStrings__fini(msg);
    return false;
  }
...
{
  rosidl_generator_c__msg__WStrings * msg = (rosidl_generator_c__msg__WStrings *)malloc(sizeof(rosidl_generator_c__msg__WStrings));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosidl_generator_c__msg__WStrings));
  bool success = rosidl_generator_c__msg__WStrings__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
rosidl_generator_c__msg__WStrings__Sequence__init(rosidl_generator_c__msg__WStrings__Sequence * array, size_t size)
{
  ...
  rosidl_generator_c__msg__WStrings * data = NULL;
  if (size) {
    data = (rosidl_generator_c__msg__WStrings *)calloc(size, sizeof(rosidl_generator_c__msg__WStrings));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosidl_generator_c__msg__WStrings__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rosidl_generator_c__msg__WStrings__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
rosidl_generator_c__msg__WStrings__Sequence__fini(rosidl_generator_c__msg__WStrings__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rosidl_generator_c__msg__WStrings__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  rosidl_generator_c__msg__WStrings__Sequence * array = (rosidl_generator_c__msg__WStrings__Sequence *)malloc(sizeof(rosidl_generator_c__msg__WStrings__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = rosidl_generator_c__msg__WStrings__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    rosidl_generator_c__msg__WStrings__Sequence__fini(array);
  }
  free(array);
}
