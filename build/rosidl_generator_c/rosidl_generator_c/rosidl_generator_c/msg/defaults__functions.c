...
{
  rosidl_generator_c__msg__Defaults * msg = (rosidl_generator_c__msg__Defaults *)malloc(sizeof(rosidl_generator_c__msg__Defaults));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosidl_generator_c__msg__Defaults));
  bool success = rosidl_generator_c__msg__Defaults__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
{
  if (msg) {
    rosidl_generator_c__msg__Defaults__fini(msg);
  }
  free(msg);
}
...
rosidl_generator_c__msg__Defaults__Sequence__init(rosidl_generator_c__msg__Defaults__Sequence * array, size_t size)
{
  ...
  rosidl_generator_c__msg__Defaults * data = NULL;
  if (size) {
    data = (rosidl_generator_c__msg__Defaults *)calloc(size, sizeof(rosidl_generator_c__msg__Defaults));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosidl_generator_c__msg__Defaults__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rosidl_generator_c__msg__Defaults__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
rosidl_generator_c__msg__Defaults__Sequence__fini(rosidl_generator_c__msg__Defaults__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rosidl_generator_c__msg__Defaults__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  rosidl_generator_c__msg__Defaults__Sequence * array = (rosidl_generator_c__msg__Defaults__Sequence *)malloc(sizeof(rosidl_generator_c__msg__Defaults__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = rosidl_generator_c__msg__Defaults__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    rosidl_generator_c__msg__Defaults__Sequence__fini(array);
  }
  free(array);
}
