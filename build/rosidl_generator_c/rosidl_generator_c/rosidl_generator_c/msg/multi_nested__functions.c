...
#include "rosidl_generator_c/msg/multi_nested__functions.h"
...
{
  rosidl_generator_c__msg__MultiNested * msg = (rosidl_generator_c__msg__MultiNested *)malloc(sizeof(rosidl_generator_c__msg__MultiNested));
  if (!msg) {
    return NULL;
  }
...
rosidl_generator_c__msg__MultiNested__Sequence__init(rosidl_generator_c__msg__MultiNested__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosidl_generator_c__msg__MultiNested *)calloc(size, sizeof(rosidl_generator_c__msg__MultiNested));
    if (!data) {
      return false;
    }
...
{
  rosidl_generator_c__msg__MultiNested__Sequence * array = (rosidl_generator_c__msg__MultiNested__Sequence *)malloc(sizeof(rosidl_generator_c__msg__MultiNested__Sequence));
  if (!array) {
    return NULL;
  }
