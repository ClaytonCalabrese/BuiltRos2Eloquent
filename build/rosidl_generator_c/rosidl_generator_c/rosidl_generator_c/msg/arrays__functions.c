...
// with input from rosidl_generator_c:msg/Arrays.idl
// generated code does not contain a copyright notice
#include "rosidl_generator_c/msg/arrays__functions.h"
...
#include "rosidl_generator_c/msg/basic_types__functions.h"
...
bool
rosidl_generator_c__msg__Arrays__init(rosidl_generator_c__msg__Arrays * msg)
{
  if (!msg) {
    return false;
  }
  ...
  for (size_t i = 0; i < 3; ++i) {
    if (!rosidl_generator_c__String__init(&msg->string_values[i])) {
      rosidl_generator_c__msg__Arrays__fini(msg);
      return false;
    }
  }
  // basic_types_values
  for (size_t i = 0; i < 3; ++i) {
    if (!rosidl_generator_c__msg__BasicTypes__init(&msg->basic_types_values[i])) {
      rosidl_generator_c__msg__Arrays__fini(msg);
      return false;
    }
  }
  // constants_values
  for (size_t i = 0; i < 3; ++i) {
    if (!rosidl_generator_c__msg__Constants__init(&msg->constants_values[i])) {
      rosidl_generator_c__msg__Arrays__fini(msg);
      return false;
    }
  }
  // defaults_values
  for (size_t i = 0; i < 3; ++i) {
    if (!rosidl_generator_c__msg__Defaults__init(&msg->defaults_values[i])) {
      rosidl_generator_c__msg__Arrays__fini(msg);
      return false;
    }
  }
...
void
rosidl_generator_c__msg__Arrays__fini(rosidl_generator_c__msg__Arrays * msg)
{
  if (!msg) {
    return;
  }
  ...
  // basic_types_values
  for (size_t i = 0; i < 3; ++i) {
    rosidl_generator_c__msg__BasicTypes__fini(&msg->basic_types_values[i]);
  }
  // constants_values
  for (size_t i = 0; i < 3; ++i) {
    rosidl_generator_c__msg__Constants__fini(&msg->constants_values[i]);
  }
  // defaults_values
  for (size_t i = 0; i < 3; ++i) {
    rosidl_generator_c__msg__Defaults__fini(&msg->defaults_values[i]);
  }
  // bool_values_default
  // byte_values_default
  // char_values_default
...
rosidl_generator_c__msg__Arrays *
rosidl_generator_c__msg__Arrays__create()
{
  rosidl_generator_c__msg__Arrays * msg = (rosidl_generator_c__msg__Arrays *)malloc(sizeof(rosidl_generator_c__msg__Arrays));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosidl_generator_c__msg__Arrays));
  bool success = rosidl_generator_c__msg__Arrays__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
void
rosidl_generator_c__msg__Arrays__destroy(rosidl_generator_c__msg__Arrays * msg)
{
  if (msg) {
    rosidl_generator_c__msg__Arrays__fini(msg);
  }
...
bool
rosidl_generator_c__msg__Arrays__Sequence__init(rosidl_generator_c__msg__Arrays__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rosidl_generator_c__msg__Arrays * data = NULL;
  if (size) {
    data = (rosidl_generator_c__msg__Arrays *)calloc(size, sizeof(rosidl_generator_c__msg__Arrays));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosidl_generator_c__msg__Arrays__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rosidl_generator_c__msg__Arrays__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
void
rosidl_generator_c__msg__Arrays__Sequence__fini(rosidl_generator_c__msg__Arrays__Sequence * array)
{
  if (!array) {
    return;
  }
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rosidl_generator_c__msg__Arrays__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
rosidl_generator_c__msg__Arrays__Sequence *
rosidl_generator_c__msg__Arrays__Sequence__create(size_t size)
{
  rosidl_generator_c__msg__Arrays__Sequence * array = (rosidl_generator_c__msg__Arrays__Sequence *)malloc(sizeof(rosidl_generator_c__msg__Arrays__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = rosidl_generator_c__msg__Arrays__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
void
rosidl_generator_c__msg__Arrays__Sequence__destroy(rosidl_generator_c__msg__Arrays__Sequence * array)
{
  if (array) {
    rosidl_generator_c__msg__Arrays__Sequence__fini(array);
  }
  free(array);
}
