...
def generate_test_description():
    ...
    processes_under_test = [
        ...
        for i, executable in enumerate('/opt/workspace/build/demo_nodes_cpp/set_and_get_parameters'.split(';'))
    ]
...
class TestExecutablesTutorial(unittest.TestCase):
    ...
    def test_processes_output(self, proc_output, processes_under_test):
        ...
        output_files = '/opt/workspace/src/ros2/demos/demo_nodes_cpp/test/set_and_get_parameters'.split(';')
