...
: ${AMENT_CURRENT_PREFIX:="/opt/workspace/install/tf2_tools"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tf2_tools/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tf2_tools/environment/path.sh"
