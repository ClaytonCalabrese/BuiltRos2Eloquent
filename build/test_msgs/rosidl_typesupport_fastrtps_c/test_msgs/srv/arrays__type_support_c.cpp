...
#include "test_msgs/srv/arrays__rosidl_typesupport_fastrtps_c.h"
...
{
  return max_serialized_size_test_msgs__srv__Arrays_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_test_msgs__srv__Arrays_Response(
    full_bounded, 0);
}
