...
#include "test_msgs/srv/basic_types__rosidl_typesupport_fastrtps_c.h"
...
static size_t _BasicTypes_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_test_msgs__srv__BasicTypes_Request(
    full_bounded, 0);
}
...
static size_t _BasicTypes_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_test_msgs__srv__BasicTypes_Response(
    full_bounded, 0);
}
