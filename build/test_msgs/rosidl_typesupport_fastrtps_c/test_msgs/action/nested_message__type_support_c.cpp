...
#include "test_msgs/action/nested_message__rosidl_typesupport_fastrtps_c.h"
...
#include "builtin_interfaces/msg/time__functions.h"  // nested_different_pkg
#include "test_msgs/msg/basic_types__functions.h"  // nested_field
#include "test_msgs/msg/builtins__functions.h"  // nested_field_no_pkg
...
{
  return max_serialized_size_test_msgs__action__NestedMessage_Goal(
    full_bounded, 0);
}
...
{
  return max_serialized_size_test_msgs__action__NestedMessage_Result(
    full_bounded, 0);
}
...
{
  return max_serialized_size_test_msgs__action__NestedMessage_Feedback(
    full_bounded, 0);
}
...
// already included above
// #include "test_msgs/action/nested_message__functions.h"  // goal
...
{
  return max_serialized_size_test_msgs__action__NestedMessage_SendGoal_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_test_msgs__action__NestedMessage_SendGoal_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_test_msgs__action__NestedMessage_GetResult_Request(
    full_bounded, 0);
}
...
// already included above
// #include "test_msgs/action/nested_message__functions.h"  // result
...
{
  return max_serialized_size_test_msgs__action__NestedMessage_GetResult_Response(
    full_bounded, 0);
}
...
// already included above
// #include "test_msgs/action/nested_message__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/uuid__functions.h"  // goal_id
...
{
  return max_serialized_size_test_msgs__action__NestedMessage_FeedbackMessage(
    full_bounded, 0);
}
