...
#include "test_msgs/srv/arrays__rosidl_typesupport_fastrtps_cpp.hpp"
...
static size_t _Arrays_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_Arrays_Request(full_bounded, 0);
}
...
static size_t _Arrays_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_Arrays_Response(full_bounded, 0);
}
