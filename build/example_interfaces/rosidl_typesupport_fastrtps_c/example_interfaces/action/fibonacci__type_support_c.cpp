...
#include "example_interfaces/action/fibonacci__rosidl_typesupport_fastrtps_c.h"
...
{
  return max_serialized_size_example_interfaces__action__Fibonacci_Goal(
    full_bounded, 0);
}
...
{
  return max_serialized_size_example_interfaces__action__Fibonacci_Result(
    full_bounded, 0);
}
...
{
  return max_serialized_size_example_interfaces__action__Fibonacci_Feedback(
    full_bounded, 0);
}
...
// already included above
// #include "example_interfaces/action/fibonacci__functions.h"  // goal
...
{
  return max_serialized_size_example_interfaces__action__Fibonacci_SendGoal_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_example_interfaces__action__Fibonacci_SendGoal_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_example_interfaces__action__Fibonacci_GetResult_Request(
    full_bounded, 0);
}
...
// already included above
// #include "example_interfaces/action/fibonacci__functions.h"  // result
...
{
  return max_serialized_size_example_interfaces__action__Fibonacci_GetResult_Response(
    full_bounded, 0);
}
...
// already included above
// #include "example_interfaces/action/fibonacci__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/uuid__functions.h"  // goal_id
...
{
  return max_serialized_size_example_interfaces__action__Fibonacci_FeedbackMessage(
    full_bounded, 0);
}
