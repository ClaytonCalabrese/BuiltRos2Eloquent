...
#include "example_interfaces/srv/add_two_ints__rosidl_typesupport_fastrtps_c.h"
...
{
  return max_serialized_size_example_interfaces__srv__AddTwoInts_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_example_interfaces__srv__AddTwoInts_Response(
    full_bounded, 0);
}
