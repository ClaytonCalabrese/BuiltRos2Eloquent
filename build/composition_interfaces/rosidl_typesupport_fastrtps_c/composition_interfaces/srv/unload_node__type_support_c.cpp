...
#include "composition_interfaces/srv/unload_node__rosidl_typesupport_fastrtps_c.h"
...
static size_t _UnloadNode_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_composition_interfaces__srv__UnloadNode_Request(
    full_bounded, 0);
}
...
static size_t _UnloadNode_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_composition_interfaces__srv__UnloadNode_Response(
    full_bounded, 0);
}
