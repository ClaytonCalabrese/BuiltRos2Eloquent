...
#include "composition_interfaces/srv/load_node__rosidl_typesupport_fastrtps_c.h"
...
#include "rcl_interfaces/msg/parameter__functions.h"  // extra_arguments, parameters
#include "rosidl_generator_c/string.h"  // node_name, node_namespace, package_name, plugin_name, remap_rules
#include "rosidl_generator_c/string_functions.h"  // node_name, node_namespace, package_name, plugin_name, remap_rules
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->package_name;
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->plugin_name;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->node_name;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->node_namespace;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: package_name
  {
    ...
    if (!ros_message->package_name.data) {
      rosidl_generator_c__String__init(&ros_message->package_name);
    }
  ...
  // Field name: plugin_name
  {
    ...
    if (!ros_message->plugin_name.data) {
      rosidl_generator_c__String__init(&ros_message->plugin_name);
    }
    bool succeeded = rosidl_generator_c__String__assign(
  ...
  // Field name: node_name
  {
    ...
    if (!ros_message->node_name.data) {
      rosidl_generator_c__String__init(&ros_message->node_name);
    }
    bool succeeded = rosidl_generator_c__String__assign(
  ...
  // Field name: node_namespace
  {
    ...
    if (!ros_message->node_namespace.data) {
      rosidl_generator_c__String__init(&ros_message->node_namespace);
    }
    bool succeeded = rosidl_generator_c__String__assign(
  ...
  // Field name: remap_rules
  {
    ...
    if (ros_message->remap_rules.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->remap_rules);
    }
    if (!rosidl_generator_c__String__Sequence__init(&ros_message->remap_rules, size)) {
      return "failed to create array for field 'remap_rules'";
    }
    auto array_ptr = ros_message->remap_rules.data;
    for (size_t i = 0; i < size; ++i) {
      std::string tmp;
  ...
  // Field name: extra_arguments
  {
    ...
    if (!rcl_interfaces__msg__Parameter__Sequence__init(&ros_message->extra_arguments, size)) {
      return "failed to create array for field 'extra_arguments'";
    }
    auto array_ptr = ros_message->extra_arguments.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
...
{
  return max_serialized_size_composition_interfaces__srv__LoadNode_Request(
    full_bounded, 0);
}
...
// already included above
// #include "rosidl_generator_c/string.h"  // error_message, full_node_name
// already included above
// #include "rosidl_generator_c/string_functions.h"  // error_message, full_node_name
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->full_node_name;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: full_node_name
  {
    ...
    if (!ros_message->full_node_name.data) {
      rosidl_generator_c__String__init(&ros_message->full_node_name);
    }
    bool succeeded = rosidl_generator_c__String__assign(
...
{
  return max_serialized_size_composition_interfaces__srv__LoadNode_Response(
    full_bounded, 0);
}
