...
#include "composition_interfaces/srv/list_nodes__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/primitives_sequence.h"  // unique_ids
#include "rosidl_generator_c/primitives_sequence_functions.h"  // unique_ids
#include "rosidl_generator_c/string.h"  // full_node_names
#include "rosidl_generator_c/string_functions.h"  // full_node_names
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: full_node_names
  {
    ...
    if (ros_message->full_node_names.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->full_node_names);
    }
  ...
  // Field name: unique_ids
  {
    ...
    if (ros_message->unique_ids.data) {
      rosidl_generator_c__uint64__Sequence__fini(&ros_message->unique_ids);
    }
