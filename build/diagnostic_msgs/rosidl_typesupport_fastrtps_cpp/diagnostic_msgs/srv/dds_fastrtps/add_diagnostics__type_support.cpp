...
#include "diagnostic_msgs/srv/add_diagnostics__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  return max_serialized_size_AddDiagnostics_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_AddDiagnostics_Response(full_bounded, 0);
}
