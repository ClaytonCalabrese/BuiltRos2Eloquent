...
#include "diagnostic_msgs/srv/add_diagnostics__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/string.h"  // load_namespace
#include "rosidl_generator_c/string_functions.h"  // load_namespace
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->load_namespace;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: load_namespace
  {
    ...
    if (!ros_message->load_namespace.data) {
      rosidl_generator_c__String__init(&ros_message->load_namespace);
    }
...
static size_t _AddDiagnostics_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_diagnostic_msgs__srv__AddDiagnostics_Request(
    full_bounded, 0);
}
...
static size_t _AddDiagnostics_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_diagnostic_msgs__srv__AddDiagnostics_Response(
    full_bounded, 0);
}
