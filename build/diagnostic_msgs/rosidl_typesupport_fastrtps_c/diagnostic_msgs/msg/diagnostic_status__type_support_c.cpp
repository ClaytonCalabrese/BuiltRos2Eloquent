...
#include "diagnostic_msgs/msg/diagnostic_status__rosidl_typesupport_fastrtps_c.h"
...
#include "diagnostic_msgs/msg/key_value__functions.h"  // values
#include "rosidl_generator_c/string.h"  // hardware_id, message, name
#include "rosidl_generator_c/string_functions.h"  // hardware_id, message, name
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->hardware_id;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: hardware_id
  {
    ...
    if (!ros_message->hardware_id.data) {
      rosidl_generator_c__String__init(&ros_message->hardware_id);
    }
    bool succeeded = rosidl_generator_c__String__assign(
