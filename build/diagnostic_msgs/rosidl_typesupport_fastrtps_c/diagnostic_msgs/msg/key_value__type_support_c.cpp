...
#include "diagnostic_msgs/msg/key_value__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/string.h"  // key, value
#include "rosidl_generator_c/string_functions.h"  // key, value

// forward declare type support functions


using _KeyValue__ros_msg_type = diagnostic_msgs__msg__KeyValue;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: value
  {
    const rosidl_generator_c__String * str = &ros_message->value;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: value
  {
    ...
    if (!ros_message->value.data) {
      rosidl_generator_c__String__init(&ros_message->value);
    }
    bool succeeded = rosidl_generator_c__String__assign(
      &ros_message->value,
      tmp.c_str());
...
{
  return max_serialized_size_diagnostic_msgs__msg__KeyValue(
    full_bounded, 0);
}
