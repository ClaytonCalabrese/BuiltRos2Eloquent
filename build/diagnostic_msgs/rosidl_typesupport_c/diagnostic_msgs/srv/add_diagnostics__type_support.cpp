...
static const _AddDiagnostics_Request_type_support_symbol_names_t _AddDiagnostics_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, diagnostic_msgs, srv, AddDiagnostics_Request)),
...
static const _AddDiagnostics_Response_type_support_symbol_names_t _AddDiagnostics_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, diagnostic_msgs, srv, AddDiagnostics_Response)),
...
static const _AddDiagnostics_type_support_symbol_names_t _AddDiagnostics_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, diagnostic_msgs, srv, AddDiagnostics)),
