...
static const _DiagnosticArray_type_support_symbol_names_t _DiagnosticArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, diagnostic_msgs, msg, DiagnosticArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, diagnostic_msgs, msg, DiagnosticArray)),
  }
};
...
{
  return &::diagnostic_msgs::msg::rosidl_typesupport_cpp::DiagnosticArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, diagnostic_msgs, msg, DiagnosticArray)() {
  return get_message_type_support_handle<diagnostic_msgs::msg::DiagnosticArray>();
}
