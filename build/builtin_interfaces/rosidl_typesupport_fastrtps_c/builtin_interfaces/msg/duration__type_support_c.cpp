...
#include "builtin_interfaces/msg/duration__rosidl_typesupport_fastrtps_c.h"
...
static size_t _Duration__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_builtin_interfaces__msg__Duration(
    full_bounded, 0);
}
