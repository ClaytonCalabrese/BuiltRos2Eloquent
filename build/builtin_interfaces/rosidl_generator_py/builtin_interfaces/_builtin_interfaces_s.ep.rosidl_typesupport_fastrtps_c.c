...
static void * builtin_interfaces__msg__duration__create_ros_message(void)
{
  return builtin_interfaces__msg__Duration__create();
}

static void builtin_interfaces__msg__duration__destroy_ros_message(void * raw_ros_message)
{
...
bool builtin_interfaces__msg__duration__convert_from_py(PyObject * _pymsg, void * ros_message);
ROSIDL_GENERATOR_C_IMPORT
...
_register_msg_type__msg__duration(PyObject * pymodule)
{
  ...
  pyobject_create_ros_message = PyCapsule_New(
    (void *)&builtin_interfaces__msg__duration__create_ros_message,
    NULL, NULL);
  ...
  pyobject_destroy_ros_message = PyCapsule_New(
    (void *)&builtin_interfaces__msg__duration__destroy_ros_message,
    NULL, NULL);
  ...
  pyobject_convert_from_py = PyCapsule_New(
    (void *)&builtin_interfaces__msg__duration__convert_from_py,
    NULL, NULL);
  ...
  pyobject_convert_to_py = PyCapsule_New(
    (void *)&builtin_interfaces__msg__duration__convert_to_py,
    NULL, NULL);
...
static void * builtin_interfaces__msg__time__create_ros_message(void)
{
  return builtin_interfaces__msg__Time__create();
}

static void builtin_interfaces__msg__time__destroy_ros_message(void * raw_ros_message)
{
...
ROSIDL_GENERATOR_C_IMPORT
bool builtin_interfaces__msg__time__convert_from_py(PyObject * _pymsg, void * ros_message);
ROSIDL_GENERATOR_C_IMPORT
...
_register_msg_type__msg__time(PyObject * pymodule)
{
  ...
  PyObject * pyobject_create_ros_message = NULL;
  pyobject_create_ros_message = PyCapsule_New(
    (void *)&builtin_interfaces__msg__time__create_ros_message,
    NULL, NULL);
  if (!pyobject_create_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_destroy_ros_message = NULL;
  pyobject_destroy_ros_message = PyCapsule_New(
    (void *)&builtin_interfaces__msg__time__destroy_ros_message,
    NULL, NULL);
  if (!pyobject_destroy_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_convert_from_py = NULL;
  pyobject_convert_from_py = PyCapsule_New(
    (void *)&builtin_interfaces__msg__time__convert_from_py,
    NULL, NULL);
  if (!pyobject_convert_from_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_convert_to_py = NULL;
  pyobject_convert_to_py = PyCapsule_New(
    (void *)&builtin_interfaces__msg__time__convert_to_py,
    NULL, NULL);
  if (!pyobject_convert_to_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
...
PyMODINIT_FUNC
PyInit_builtin_interfaces_s__rosidl_typesupport_fastrtps_c(void)
{
