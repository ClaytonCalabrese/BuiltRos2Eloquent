...
#include "rcl_interfaces/srv/list_parameters__rosidl_typesupport_fastrtps_c.h"
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: prefixes
  {
    ...
    if (ros_message->prefixes.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->prefixes);
    }
...
static size_t _ListParameters_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rcl_interfaces__srv__ListParameters_Request(
    full_bounded, 0);
}
...
static size_t _ListParameters_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rcl_interfaces__srv__ListParameters_Response(
    full_bounded, 0);
}
