...
#include "rcl_interfaces/srv/describe_parameters__rosidl_typesupport_fastrtps_c.h"
...
{
  return max_serialized_size_rcl_interfaces__srv__DescribeParameters_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_rcl_interfaces__srv__DescribeParameters_Response(
    full_bounded, 0);
}
