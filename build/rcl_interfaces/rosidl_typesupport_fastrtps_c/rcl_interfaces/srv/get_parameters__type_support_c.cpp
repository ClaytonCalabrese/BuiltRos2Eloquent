...
#include "rcl_interfaces/srv/get_parameters__rosidl_typesupport_fastrtps_c.h"
...
static size_t _GetParameters_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rcl_interfaces__srv__GetParameters_Request(
    full_bounded, 0);
}
...
static size_t _GetParameters_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rcl_interfaces__srv__GetParameters_Response(
    full_bounded, 0);
}
