...
#include "rcl_interfaces/srv/get_parameter_types__rosidl_typesupport_fastrtps_c.h"
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: names
  {
    ...
    if (ros_message->names.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->names);
    }
...
static size_t _GetParameterTypes_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rcl_interfaces__srv__GetParameterTypes_Request(
    full_bounded, 0);
}
...
#include "rosidl_generator_c/primitives_sequence.h"  // types
#include "rosidl_generator_c/primitives_sequence_functions.h"  // types
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: types
  {
    ...
    if (ros_message->types.data) {
      rosidl_generator_c__uint8__Sequence__fini(&ros_message->types);
    }
...
static size_t _GetParameterTypes_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rcl_interfaces__srv__GetParameterTypes_Response(
    full_bounded, 0);
}
