...
#include "rcl_interfaces/msg/parameter_value__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/primitives_sequence.h"  // bool_array_value, byte_array_value, double_array_value, integer_array_value
#include "rosidl_generator_c/primitives_sequence_functions.h"  // bool_array_value, byte_array_value, double_array_value, integer_array_value
#include "rosidl_generator_c/string.h"  // string_array_value, string_value
#include "rosidl_generator_c/string_functions.h"  // string_array_value, string_value
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: byte_array_value
  {
    ...
    if (ros_message->byte_array_value.data) {
      rosidl_generator_c__octet__Sequence__fini(&ros_message->byte_array_value);
    }
    if (!rosidl_generator_c__octet__Sequence__init(&ros_message->byte_array_value, size)) {
      return "failed to create array for field 'byte_array_value'";
    }
    auto array_ptr = ros_message->byte_array_value.data;
  ...
  // Field name: bool_array_value
  {
    ...
    if (ros_message->bool_array_value.data) {
      rosidl_generator_c__boolean__Sequence__fini(&ros_message->bool_array_value);
    }
    if (!rosidl_generator_c__boolean__Sequence__init(&ros_message->bool_array_value, size)) {
      return "failed to create array for field 'bool_array_value'";
    }
    auto array_ptr = ros_message->bool_array_value.data;
    for (size_t i = 0; i < size; ++i) {
      uint8_t tmp;
  ...
  // Field name: integer_array_value
  {
    ...
    if (ros_message->integer_array_value.data) {
      rosidl_generator_c__int64__Sequence__fini(&ros_message->integer_array_value);
    }
    if (!rosidl_generator_c__int64__Sequence__init(&ros_message->integer_array_value, size)) {
      return "failed to create array for field 'integer_array_value'";
    }
    auto array_ptr = ros_message->integer_array_value.data;
    cdr.deserializeArray(array_ptr, size);
  }
  ...
  // Field name: double_array_value
  {
    ...
    if (ros_message->double_array_value.data) {
      rosidl_generator_c__double__Sequence__fini(&ros_message->double_array_value);
    }
    if (!rosidl_generator_c__double__Sequence__init(&ros_message->double_array_value, size)) {
      return "failed to create array for field 'double_array_value'";
    }
    auto array_ptr = ros_message->double_array_value.data;
    cdr.deserializeArray(array_ptr, size);
  }
  ...
  // Field name: string_array_value
  {
    ...
    if (ros_message->string_array_value.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->string_array_value);
    }
    if (!rosidl_generator_c__String__Sequence__init(&ros_message->string_array_value, size)) {
      return "failed to create array for field 'string_array_value'";
    }
    auto array_ptr = ros_message->string_array_value.data;
    for (size_t i = 0; i < size; ++i) {
      std::string tmp;
...
static size_t _ParameterValue__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rcl_interfaces__msg__ParameterValue(
    full_bounded, 0);
}
