...
#include "rcl_interfaces/msg/parameter_descriptor__rosidl_typesupport_fastrtps_c.h"
...
#include "rcl_interfaces/msg/floating_point_range__functions.h"  // floating_point_range
#include "rcl_interfaces/msg/integer_range__functions.h"  // integer_range
#include "rosidl_generator_c/string.h"  // additional_constraints, description, name
#include "rosidl_generator_c/string_functions.h"  // additional_constraints, description, name
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->description;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->additional_constraints;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: description
  {
    ...
    if (!ros_message->description.data) {
      rosidl_generator_c__String__init(&ros_message->description);
    }
    bool succeeded = rosidl_generator_c__String__assign(
  ...
  // Field name: additional_constraints
  {
    ...
    if (!ros_message->additional_constraints.data) {
      rosidl_generator_c__String__init(&ros_message->additional_constraints);
    }
    bool succeeded = rosidl_generator_c__String__assign(
  ...
  // Field name: floating_point_range
  {
    ...
    if (!rcl_interfaces__msg__FloatingPointRange__Sequence__init(&ros_message->floating_point_range, size)) {
      return "failed to create array for field 'floating_point_range'";
    }
    auto array_ptr = ros_message->floating_point_range.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  // Field name: integer_range
  {
    ...
    if (!rcl_interfaces__msg__IntegerRange__Sequence__init(&ros_message->integer_range, size)) {
      return "failed to create array for field 'integer_range'";
    }
    auto array_ptr = ros_message->integer_range.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
...
{
  return max_serialized_size_rcl_interfaces__msg__ParameterDescriptor(
    full_bounded, 0);
}
