...
#include "rcl_interfaces/msg/log__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/string.h"  // file, function, msg, name
#include "rosidl_generator_c/string_functions.h"  // file, function, msg, name
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: msg
  {
    const rosidl_generator_c__String * str = &ros_message->msg;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  // Field name: file
  {
    const rosidl_generator_c__String * str = &ros_message->file;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  // Field name: function
  {
    const rosidl_generator_c__String * str = &ros_message->function;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: msg
  {
    ...
    if (!ros_message->msg.data) {
      rosidl_generator_c__String__init(&ros_message->msg);
    }
    bool succeeded = rosidl_generator_c__String__assign(
      &ros_message->msg,
      tmp.c_str());
  ...
  // Field name: file
  {
    ...
    if (!ros_message->file.data) {
      rosidl_generator_c__String__init(&ros_message->file);
    }
    bool succeeded = rosidl_generator_c__String__assign(
      &ros_message->file,
      tmp.c_str());
  ...
  // Field name: function
  {
    ...
    if (!ros_message->function.data) {
      rosidl_generator_c__String__init(&ros_message->function);
    }
    bool succeeded = rosidl_generator_c__String__assign(
...
{
  return max_serialized_size_rcl_interfaces__msg__Log(
    full_bounded, 0);
}
