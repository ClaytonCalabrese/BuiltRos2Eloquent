...
#include "rcl_interfaces/msg/integer_range__rosidl_typesupport_fastrtps_c.h"
...
static size_t _IntegerRange__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rcl_interfaces__msg__IntegerRange(
    full_bounded, 0);
}
