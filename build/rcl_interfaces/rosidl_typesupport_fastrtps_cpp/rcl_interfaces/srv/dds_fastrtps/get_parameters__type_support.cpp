...
#include "rcl_interfaces/srv/get_parameters__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  return max_serialized_size_GetParameters_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_GetParameters_Response(full_bounded, 0);
}
