...
#include "rcl_interfaces/srv/set_parameters_atomically__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  return max_serialized_size_SetParametersAtomically_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_SetParametersAtomically_Response(full_bounded, 0);
}
