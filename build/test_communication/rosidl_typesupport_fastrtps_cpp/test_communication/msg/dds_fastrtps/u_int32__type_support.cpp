...
#include "test_communication/msg/u_int32__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const test_communication::msg::UInt32 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<test_communication::msg::UInt32 *>(
    untyped_ros_message);
...
{
  return &test_communication::msg::typesupport_fastrtps_cpp::_UInt32__handle;
}
