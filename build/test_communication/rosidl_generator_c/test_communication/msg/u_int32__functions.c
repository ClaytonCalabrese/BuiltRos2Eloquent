...
bool
test_communication__msg__UInt32__Sequence__init(test_communication__msg__UInt32__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
...
void
test_communication__msg__UInt32__Sequence__fini(test_communication__msg__UInt32__Sequence * array)
{
  if (!array) {
    return;
  }
...
test_communication__msg__UInt32__Sequence__create(size_t size)
{
  test_communication__msg__UInt32__Sequence * array = (test_communication__msg__UInt32__Sequence *)malloc(sizeof(test_communication__msg__UInt32__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = test_communication__msg__UInt32__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
void
test_communication__msg__UInt32__Sequence__destroy(test_communication__msg__UInt32__Sequence * array)
{
  if (array) {
    test_communication__msg__UInt32__Sequence__fini(array);
  }
  free(array);
}
