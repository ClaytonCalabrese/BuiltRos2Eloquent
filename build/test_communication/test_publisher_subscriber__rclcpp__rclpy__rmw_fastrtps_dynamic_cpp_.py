...
def generate_test_description(message_type, ready_fn):
    ...
    publisher_cmd = ['/opt/workspace/build/test_communication/test_publisher_cpp', message_type, namespace]
    ...
    publisher_env['RCL_ASSERT_RMW_ID_MATCHES'] = 'rmw_fastrtps_dynamic_cpp'
    publisher_env['RMW_IMPLEMENTATION'] = 'rmw_fastrtps_dynamic_cpp'
    ...
    subscriber_env['RCL_ASSERT_RMW_ID_MATCHES'] = 'rmw_fastrtps_dynamic_cpp'
    subscriber_env['RMW_IMPLEMENTATION'] = 'rmw_fastrtps_dynamic_cpp'
