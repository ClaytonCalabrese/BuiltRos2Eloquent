...
#ifndef _WIN32
# define DEPRECATED__test_communication__msg__UInt32 __attribute__((deprecated))
#else
# define DEPRECATED__test_communication__msg__UInt32 __declspec(deprecated)
#endif
...
struct UInt32_
{
  ...
  typedef DEPRECATED__test_communication__msg__UInt32
    std::shared_ptr<test_communication::msg::UInt32_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__test_communication__msg__UInt32
    std::shared_ptr<test_communication::msg::UInt32_<ContainerAllocator> const>
