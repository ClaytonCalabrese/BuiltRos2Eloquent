...
def generate_test_description(service_type, ready_fn):
    ...
    requester_cmd = ['/opt/workspace/build/test_communication/test_requester_cpp', service_type, namespace]
    replier_cmd = ['/opt/workspace/src/ros2/system_tests/test_communication/test/replier_py.py', service_type, namespace]
    ...
    replier_env['RCL_ASSERT_RMW_ID_MATCHES'] = 'rmw_fastrtps_dynamic_cpp'
    replier_env['RMW_IMPLEMENTATION'] = 'rmw_fastrtps_dynamic_cpp'
    ...
    requester_env['RCL_ASSERT_RMW_ID_MATCHES'] = 'rmw_fastrtps_dynamic_cpp'
    requester_env['RMW_IMPLEMENTATION'] = 'rmw_fastrtps_dynamic_cpp'
