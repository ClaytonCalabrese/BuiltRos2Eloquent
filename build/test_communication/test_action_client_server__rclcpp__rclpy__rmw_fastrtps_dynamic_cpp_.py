...
def generate_test_description(action_type, ready_fn):
    ...
    action_client_cmd = ['/opt/workspace/build/test_communication/test_action_client_cpp', action_type, namespace]
    action_server_cmd = ['/opt/workspace/src/ros2/system_tests/test_communication/test/action_server_py.py', action_type, namespace]
    ...
    action_server_env['RCL_ASSERT_RMW_ID_MATCHES'] = 'rmw_fastrtps_dynamic_cpp'
    action_server_env['RMW_IMPLEMENTATION'] = 'rmw_fastrtps_dynamic_cpp'
    ...
    action_client_env['RCL_ASSERT_RMW_ID_MATCHES'] = 'rmw_fastrtps_dynamic_cpp'
    action_client_env['RMW_IMPLEMENTATION'] = 'rmw_fastrtps_dynamic_cpp'
