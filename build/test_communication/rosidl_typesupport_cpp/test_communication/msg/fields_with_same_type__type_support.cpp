...
static const _FieldsWithSameType_type_support_symbol_names_t _FieldsWithSameType_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_communication, msg, FieldsWithSameType)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, test_communication, msg, FieldsWithSameType)),
  }
};
...
{
  return &::test_communication::msg::rosidl_typesupport_cpp::FieldsWithSameType_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, test_communication, msg, FieldsWithSameType)() {
  return get_message_type_support_handle<test_communication::msg::FieldsWithSameType>();
}
