...
#include "test_rclcpp/msg/u_int32__rosidl_typesupport_fastrtps_c.h"
...
using _UInt32__ros_msg_type = test_rclcpp__msg__UInt32;
...
size_t get_serialized_size_test_rclcpp__msg__UInt32(
  const void * untyped_ros_message,
...
static uint32_t _UInt32__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_test_rclcpp__msg__UInt32(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_test_rclcpp
size_t max_serialized_size_test_rclcpp__msg__UInt32(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_test_rclcpp__msg__UInt32(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, test_rclcpp, msg, UInt32)() {
