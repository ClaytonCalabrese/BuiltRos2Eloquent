...
#include <stddef.h>
#include "test_rclcpp/srv/add_two_ints__rosidl_typesupport_introspection_c.h"
#include "test_rclcpp/msg/rosidl_typesupport_introspection_c__visibility_control.h"
  ...
  void * message_memory, enum rosidl_runtime_c_message_initialization _init)
{
  ...
  (void) _init;
  test_rclcpp__srv__AddTwoInts_Request__init(message_memory);
}

void AddTwoInts_Request__rosidl_typesupport_introspection_c__AddTwoInts_Request_fini_function(void * message_memory)
{
  test_rclcpp__srv__AddTwoInts_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember AddTwoInts_Request__rosidl_typesupport_introspection_c__AddTwoInts_Request_message_member_array[2] = {
  {
    ...
    offsetof(test_rclcpp__srv__AddTwoInts_Request, a),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_rclcpp__srv__AddTwoInts_Request, b),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers AddTwoInts_Request__rosidl_typesupport_introspection_c__AddTwoInts_Request_message_members = {
  "test_rclcpp__srv",  // message namespace
  "AddTwoInts_Request",  // message name
  2,  // number of fields
  sizeof(test_rclcpp__srv__AddTwoInts_Request),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_test_rclcpp
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_rclcpp, srv, AddTwoInts_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c_message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  test_rclcpp__srv__AddTwoInts_Response__init(message_memory);
}

void AddTwoInts_Response__rosidl_typesupport_introspection_c__AddTwoInts_Response_fini_function(void * message_memory)
{
  test_rclcpp__srv__AddTwoInts_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember AddTwoInts_Response__rosidl_typesupport_introspection_c__AddTwoInts_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_rclcpp__srv__AddTwoInts_Response, sum),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers AddTwoInts_Response__rosidl_typesupport_introspection_c__AddTwoInts_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(test_rclcpp__srv__AddTwoInts_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_test_rclcpp
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_rclcpp, srv, AddTwoInts_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers test_rclcpp__srv__add_two_ints__rosidl_typesupport_introspection_c__AddTwoInts_service_members = {
  "test_rclcpp__srv",  // service namespace
  "AddTwoInts",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // test_rclcpp__srv__add_two_ints__rosidl_typesupport_introspection_c__AddTwoInts_Request_message_type_support_handle,
  NULL  // response message
  // test_rclcpp__srv__add_two_ints__rosidl_typesupport_introspection_c__AddTwoInts_Response_message_type_support_handle
};

static rosidl_service_type_support_t test_rclcpp__srv__add_two_ints__rosidl_typesupport_introspection_c__AddTwoInts_service_type_support_handle = {
  0,
  &test_rclcpp__srv__add_two_ints__rosidl_typesupport_introspection_c__AddTwoInts_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_rclcpp, srv, AddTwoInts)() {
  if (!test_rclcpp__srv__add_two_ints__rosidl_typesupport_introspection_c__AddTwoInts_service_type_support_handle.typesupport_identifier) {
    test_rclcpp__srv__add_two_ints__rosidl_typesupport_introspection_c__AddTwoInts_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)test_rclcpp__srv__add_two_ints__rosidl_typesupport_introspection_c__AddTwoInts_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_rclcpp, srv, AddTwoInts_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_rclcpp, srv, AddTwoInts_Response)()->data;
  }

  return &test_rclcpp__srv__add_two_ints__rosidl_typesupport_introspection_c__AddTwoInts_service_type_support_handle;
}
