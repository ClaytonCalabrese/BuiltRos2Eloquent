...
#include <stddef.h>
#include "test_rclcpp/msg/u_int32__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c_message_initialization _init)
{
  ...
  (void) _init;
  test_rclcpp__msg__UInt32__init(message_memory);
}

void UInt32__rosidl_typesupport_introspection_c__UInt32_fini_function(void * message_memory)
{
  test_rclcpp__msg__UInt32__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember UInt32__rosidl_typesupport_introspection_c__UInt32_message_member_array[1] = {
  {
    ...
    offsetof(test_rclcpp__msg__UInt32, data),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers UInt32__rosidl_typesupport_introspection_c__UInt32_message_members = {
  "test_rclcpp__msg",  // message namespace
  "UInt32",  // message name
  1,  // number of fields
  sizeof(test_rclcpp__msg__UInt32),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_rclcpp, msg, UInt32)() {
