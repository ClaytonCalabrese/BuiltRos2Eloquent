...
{
  new (message_memory) test_rclcpp::msg::UInt32(_init);
}

void UInt32_fini_function(void * message_memory)
{
  auto typed_message = static_cast<test_rclcpp::msg::UInt32 *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember UInt32_message_member_array[1] = {
  {
    ...
    offsetof(test_rclcpp::msg::UInt32, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers UInt32_message_members = {
  "test_rclcpp::msg",  // message namespace
  "UInt32",  // message name
  1,  // number of fields
  sizeof(test_rclcpp::msg::UInt32),
...
{
  return &::test_rclcpp::msg::rosidl_typesupport_introspection_cpp::UInt32_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, test_rclcpp, msg, UInt32)() {
  return &::test_rclcpp::msg::rosidl_typesupport_introspection_cpp::UInt32_message_type_support_handle;
}
