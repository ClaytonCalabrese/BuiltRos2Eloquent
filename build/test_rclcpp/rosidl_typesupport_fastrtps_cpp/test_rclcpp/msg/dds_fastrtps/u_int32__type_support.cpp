...
#include "test_rclcpp/msg/u_int32__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const test_rclcpp::msg::UInt32 & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  test_rclcpp::msg::UInt32 & ros_message)
{
  // Member: data
  cdr >> ros_message.data;
...
{
  auto typed_message =
    static_cast<const test_rclcpp::msg::UInt32 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<test_rclcpp::msg::UInt32 *>(
    untyped_ros_message);
...
{
  return &test_rclcpp::msg::typesupport_fastrtps_cpp::_UInt32__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_rclcpp, msg, UInt32)() {
  return &test_rclcpp::msg::typesupport_fastrtps_cpp::_UInt32__handle;
}
