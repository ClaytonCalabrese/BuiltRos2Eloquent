...
#include "test_rclcpp/srv/add_two_ints__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const test_rclcpp::srv::AddTwoInts_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<test_rclcpp::srv::AddTwoInts_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_test_rclcpp
const rosidl_message_type_support_t *
get_message_type_support_handle<test_rclcpp::srv::AddTwoInts_Request>()
{
  return &test_rclcpp::srv::typesupport_fastrtps_cpp::_AddTwoInts_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const test_rclcpp::srv::AddTwoInts_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<test_rclcpp::srv::AddTwoInts_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &test_rclcpp::srv::typesupport_fastrtps_cpp::_AddTwoInts_Response__handle;
}
...
{
  return &test_rclcpp::srv::typesupport_fastrtps_cpp::_AddTwoInts__handle;
}
