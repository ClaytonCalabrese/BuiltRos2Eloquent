...
set(_exported_libraries "turtlesim__rosidl_typesupport_cpp;turtlesim__rosidl_typesupport_c;turtlesim__rosidl_typesupport_introspection_cpp;turtlesim__rosidl_generator_c;turtlesim__rosidl_typesupport_introspection_c;turtlesim__rosidl_typesupport_fastrtps_c;turtlesim__rosidl_typesupport_fastrtps_cpp")
...
if(NOT _exported_library_names STREQUAL "")
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING "Package 'turtlesim' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND turtlesim_LIBRARIES ${_cfg} "${_lib}")
