...
static const _ChannelFloat32_type_support_symbol_names_t _ChannelFloat32_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sensor_msgs, msg, ChannelFloat32)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sensor_msgs, msg, ChannelFloat32)),
  }
};
...
{
  return &::sensor_msgs::msg::rosidl_typesupport_cpp::ChannelFloat32_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sensor_msgs, msg, ChannelFloat32)() {
  return get_message_type_support_handle<sensor_msgs::msg::ChannelFloat32>();
}
