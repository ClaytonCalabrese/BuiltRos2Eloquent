...
#include "sensor_msgs/msg/multi_echo_laser_scan__rosidl_typesupport_fastrtps_c.h"
...
#include "sensor_msgs/msg/laser_echo__functions.h"  // intensities, ranges
...
static size_t _MultiEchoLaserScan__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_sensor_msgs__msg__MultiEchoLaserScan(
    full_bounded, 0);
}
