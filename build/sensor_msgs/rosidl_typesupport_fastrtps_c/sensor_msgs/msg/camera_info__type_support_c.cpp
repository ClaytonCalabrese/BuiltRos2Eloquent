...
#include "sensor_msgs/msg/camera_info__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/primitives_sequence.h"  // d
#include "rosidl_generator_c/primitives_sequence_functions.h"  // d
#include "rosidl_generator_c/string.h"  // distortion_model
#include "rosidl_generator_c/string_functions.h"  // distortion_model
#include "sensor_msgs/msg/region_of_interest__functions.h"  // roi
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->distortion_model;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: distortion_model
  {
    ...
    if (!ros_message->distortion_model.data) {
      rosidl_generator_c__String__init(&ros_message->distortion_model);
    }
  ...
  // Field name: d
  {
    ...
    if (ros_message->d.data) {
      rosidl_generator_c__double__Sequence__fini(&ros_message->d);
    }
    if (!rosidl_generator_c__double__Sequence__init(&ros_message->d, size)) {
      return "failed to create array for field 'd'";
    }
    auto array_ptr = ros_message->d.data;
...
{
  return max_serialized_size_sensor_msgs__msg__CameraInfo(
    full_bounded, 0);
}
