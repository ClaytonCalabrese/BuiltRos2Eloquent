...
#include "sensor_msgs/msg/illuminance__rosidl_typesupport_fastrtps_c.h"
  ...
  void * untyped_ros_message)
{
  ...
  _Illuminance__ros_msg_type * ros_message = static_cast<_Illuminance__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
{
  return max_serialized_size_sensor_msgs__msg__Illuminance(
    full_bounded, 0);
}
