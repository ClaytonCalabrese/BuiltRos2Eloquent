...
#include "sensor_msgs/msg/nav_sat_status__rosidl_typesupport_fastrtps_c.h"
  ...
  void * untyped_ros_message)
{
  ...
  _NavSatStatus__ros_msg_type * ros_message = static_cast<_NavSatStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: status
  {
    cdr >> ros_message->status;
  }
...
static size_t _NavSatStatus__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_sensor_msgs__msg__NavSatStatus(
    full_bounded, 0);
}
