...
#include "sensor_msgs/msg/point_field__rosidl_typesupport_fastrtps_c.h"
...
using _PointField__ros_msg_type = sensor_msgs__msg__PointField;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PointField__ros_msg_type * ros_message = static_cast<const _PointField__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
  ...
  void * untyped_ros_message)
{
  ...
  _PointField__ros_msg_type * ros_message = static_cast<_PointField__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
    std::string tmp;
    cdr >> tmp;
...
static size_t _PointField__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_sensor_msgs__msg__PointField(
    full_bounded, 0);
}
