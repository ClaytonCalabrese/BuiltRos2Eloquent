...
#include "sensor_msgs/msg/nav_sat_fix__rosidl_typesupport_fastrtps_c.h"
...
#include "sensor_msgs/msg/nav_sat_status__functions.h"  // status
  ...
  void * untyped_ros_message)
{
  ...
  _NavSatFix__ros_msg_type * ros_message = static_cast<_NavSatFix__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
{
  return max_serialized_size_sensor_msgs__msg__NavSatFix(
    full_bounded, 0);
}
