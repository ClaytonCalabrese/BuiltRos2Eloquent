...
#include "sensor_msgs/msg/channel_float32__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/primitives_sequence.h"  // values
#include "rosidl_generator_c/primitives_sequence_functions.h"  // values
  ...
  void * untyped_ros_message)
{
  ...
  _ChannelFloat32__ros_msg_type * ros_message = static_cast<_ChannelFloat32__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
    std::string tmp;
    cdr >> tmp;
  ...
  // Field name: values
  {
    ...
    if (ros_message->values.data) {
      rosidl_generator_c__float__Sequence__fini(&ros_message->values);
    }
...
static size_t _ChannelFloat32__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_sensor_msgs__msg__ChannelFloat32(
    full_bounded, 0);
}
