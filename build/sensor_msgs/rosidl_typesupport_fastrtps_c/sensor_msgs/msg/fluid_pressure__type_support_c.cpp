...
#include "sensor_msgs/msg/fluid_pressure__rosidl_typesupport_fastrtps_c.h"
  ...
  void * untyped_ros_message)
{
  ...
  _FluidPressure__ros_msg_type * ros_message = static_cast<_FluidPressure__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static size_t _FluidPressure__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_sensor_msgs__msg__FluidPressure(
    full_bounded, 0);
}
