...
#include "sensor_msgs/msg/joint_state__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/primitives_sequence.h"  // effort, position, velocity
#include "rosidl_generator_c/primitives_sequence_functions.h"  // effort, position, velocity
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: name
  {
    ...
    if (ros_message->name.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->name);
    }
...
{
  return max_serialized_size_sensor_msgs__msg__JointState(
    full_bounded, 0);
}
