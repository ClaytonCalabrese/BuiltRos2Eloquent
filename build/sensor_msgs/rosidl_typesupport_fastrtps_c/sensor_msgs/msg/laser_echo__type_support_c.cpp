...
#include "sensor_msgs/msg/laser_echo__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/primitives_sequence.h"  // echoes
#include "rosidl_generator_c/primitives_sequence_functions.h"  // echoes
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: echoes
  {
    ...
    if (ros_message->echoes.data) {
      rosidl_generator_c__float__Sequence__fini(&ros_message->echoes);
    }
    if (!rosidl_generator_c__float__Sequence__init(&ros_message->echoes, size)) {
      return "failed to create array for field 'echoes'";
    }
    auto array_ptr = ros_message->echoes.data;
...
static size_t _LaserEcho__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_sensor_msgs__msg__LaserEcho(
    full_bounded, 0);
}
