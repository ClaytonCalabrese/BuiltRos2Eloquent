...
#include "sensor_msgs/msg/point_cloud2__rosidl_typesupport_fastrtps_c.h"
...
#include "sensor_msgs/msg/point_field__functions.h"  // fields
  ...
  void * untyped_ros_message)
{
  ...
  _PointCloud2__ros_msg_type * ros_message = static_cast<_PointCloud2__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: fields
  {
    ...
    if (!sensor_msgs__msg__PointField__Sequence__init(&ros_message->fields, size)) {
      return "failed to create array for field 'fields'";
    }
    auto array_ptr = ros_message->fields.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
...
static size_t _PointCloud2__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_sensor_msgs__msg__PointCloud2(
    full_bounded, 0);
}
