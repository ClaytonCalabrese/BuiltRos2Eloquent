...
#include "sensor_msgs/msg/magnetic_field__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/vector3__functions.h"  // magnetic_field
  ...
  void * untyped_ros_message)
{
  ...
  _MagneticField__ros_msg_type * ros_message = static_cast<_MagneticField__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
{
  return max_serialized_size_sensor_msgs__msg__MagneticField(
    full_bounded, 0);
}
