...
#include "sensor_msgs/msg/region_of_interest__rosidl_typesupport_fastrtps_c.h"
...
static size_t _RegionOfInterest__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_sensor_msgs__msg__RegionOfInterest(
    full_bounded, 0);
}
