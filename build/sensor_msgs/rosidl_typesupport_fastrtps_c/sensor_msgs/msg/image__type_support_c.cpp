...
#include "sensor_msgs/msg/image__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/string.h"  // encoding
#include "rosidl_generator_c/string_functions.h"  // encoding
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: encoding
  {
    const rosidl_generator_c__String * str = &ros_message->encoding;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: encoding
  {
    ...
    if (!ros_message->encoding.data) {
      rosidl_generator_c__String__init(&ros_message->encoding);
    }
...
{
  return max_serialized_size_sensor_msgs__msg__Image(
    full_bounded, 0);
}
