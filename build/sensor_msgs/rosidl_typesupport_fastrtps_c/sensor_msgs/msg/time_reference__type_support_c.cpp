...
#include "sensor_msgs/msg/time_reference__rosidl_typesupport_fastrtps_c.h"
...
#include "builtin_interfaces/msg/time__functions.h"  // time_ref
#include "rosidl_generator_c/string.h"  // source
#include "rosidl_generator_c/string_functions.h"  // source
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: source
  {
    const rosidl_generator_c__String * str = &ros_message->source;
  ...
  void * untyped_ros_message)
{
  ...
  _TimeReference__ros_msg_type * ros_message = static_cast<_TimeReference__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: source
  {
    ...
    if (!ros_message->source.data) {
      rosidl_generator_c__String__init(&ros_message->source);
    }
...
static size_t _TimeReference__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_sensor_msgs__msg__TimeReference(
    full_bounded, 0);
}
