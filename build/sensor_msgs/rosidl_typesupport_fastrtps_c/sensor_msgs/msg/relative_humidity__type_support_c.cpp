...
#include "sensor_msgs/msg/relative_humidity__rosidl_typesupport_fastrtps_c.h"
...
using _RelativeHumidity__ros_msg_type = sensor_msgs__msg__RelativeHumidity;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RelativeHumidity__ros_msg_type * ros_message = static_cast<const _RelativeHumidity__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _RelativeHumidity__ros_msg_type * ros_message = static_cast<_RelativeHumidity__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static size_t _RelativeHumidity__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_sensor_msgs__msg__RelativeHumidity(
    full_bounded, 0);
}
