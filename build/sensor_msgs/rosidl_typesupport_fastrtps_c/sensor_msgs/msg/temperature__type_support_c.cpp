...
#include "sensor_msgs/msg/temperature__rosidl_typesupport_fastrtps_c.h"
...
using _Temperature__ros_msg_type = sensor_msgs__msg__Temperature;
...
{
  return max_serialized_size_sensor_msgs__msg__Temperature(
    full_bounded, 0);
}
