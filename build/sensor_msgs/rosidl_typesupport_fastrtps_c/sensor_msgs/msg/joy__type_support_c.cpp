...
#include "sensor_msgs/msg/joy__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/primitives_sequence.h"  // axes, buttons
#include "rosidl_generator_c/primitives_sequence_functions.h"  // axes, buttons
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: axes
  {
    ...
    if (ros_message->axes.data) {
      rosidl_generator_c__float__Sequence__fini(&ros_message->axes);
    }
    if (!rosidl_generator_c__float__Sequence__init(&ros_message->axes, size)) {
      return "failed to create array for field 'axes'";
    }
    auto array_ptr = ros_message->axes.data;
  ...
  // Field name: buttons
  {
    ...
    if (ros_message->buttons.data) {
      rosidl_generator_c__int32__Sequence__fini(&ros_message->buttons);
    }
    if (!rosidl_generator_c__int32__Sequence__init(&ros_message->buttons, size)) {
      return "failed to create array for field 'buttons'";
    }
    auto array_ptr = ros_message->buttons.data;
    cdr.deserializeArray(array_ptr, size);
  }
...
static size_t _Joy__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_sensor_msgs__msg__Joy(
    full_bounded, 0);
}
