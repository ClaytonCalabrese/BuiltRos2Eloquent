...
#include "sensor_msgs/msg/compressed_image__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/string.h"  // format
#include "rosidl_generator_c/string_functions.h"  // format
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: format
  {
    const rosidl_generator_c__String * str = &ros_message->format;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: format
  {
    ...
    if (!ros_message->format.data) {
      rosidl_generator_c__String__init(&ros_message->format);
    }
...
{
  return max_serialized_size_sensor_msgs__msg__CompressedImage(
    full_bounded, 0);
}
