...
#include "std_msgs/msg/color_rgba__rosidl_typesupport_fastrtps_c.h"
...
static size_t _ColorRGBA__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_std_msgs__msg__ColorRGBA(
    full_bounded, 0);
}
