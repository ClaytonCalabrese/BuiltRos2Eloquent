...
#include "unique_identifier_msgs/msg/uuid__rosidl_typesupport_fastrtps_c.h"
...
static size_t _UUID__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_unique_identifier_msgs__msg__UUID(
    full_bounded, 0);
}
