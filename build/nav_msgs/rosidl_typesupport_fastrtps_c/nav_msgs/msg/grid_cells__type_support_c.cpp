...
#include "nav_msgs/msg/grid_cells__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/point__functions.h"  // cells
  ...
  void * untyped_ros_message)
{
  ...
  _GridCells__ros_msg_type * ros_message = static_cast<_GridCells__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static size_t _GridCells__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_nav_msgs__msg__GridCells(
    full_bounded, 0);
}
