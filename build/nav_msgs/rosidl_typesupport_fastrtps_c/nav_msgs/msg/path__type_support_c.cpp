...
#include "nav_msgs/msg/path__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/pose_stamped__functions.h"  // poses
...
{
  return max_serialized_size_nav_msgs__msg__Path(
    full_bounded, 0);
}
