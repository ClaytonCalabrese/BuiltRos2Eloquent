...
#include "nav_msgs/srv/set_map__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/pose_with_covariance_stamped__functions.h"  // initial_pose
...
static size_t _SetMap_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_nav_msgs__srv__SetMap_Request(
    full_bounded, 0);
}
...
static size_t _SetMap_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_nav_msgs__srv__SetMap_Response(
    full_bounded, 0);
}
