...
#include "nav_msgs/srv/get_plan__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/pose_stamped__functions.h"  // goal, start
...
{
  return max_serialized_size_nav_msgs__srv__GetPlan_Request(
    full_bounded, 0);
}
...
#include "nav_msgs/msg/path__functions.h"  // plan
...
{
  return max_serialized_size_nav_msgs__srv__GetPlan_Response(
    full_bounded, 0);
}
