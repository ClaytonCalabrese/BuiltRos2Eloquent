...
#ifndef ROSIDL_GENERATOR_CPP__MSG__EMPTY__STRUCT_HPP_
#define ROSIDL_GENERATOR_CPP__MSG__EMPTY__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__rosidl_generator_cpp__msg__Empty __attribute__((deprecated))
#else
# define DEPRECATED__rosidl_generator_cpp__msg__Empty __declspec(deprecated)
#endif
...
struct Empty_
{
  ...
  typedef DEPRECATED__rosidl_generator_cpp__msg__Empty
    std::shared_ptr<rosidl_generator_cpp::msg::Empty_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__rosidl_generator_cpp__msg__Empty
    std::shared_ptr<rosidl_generator_cpp::msg::Empty_<ContainerAllocator> const>
...
#endif  // ROSIDL_GENERATOR_CPP__MSG__EMPTY__STRUCT_HPP_
