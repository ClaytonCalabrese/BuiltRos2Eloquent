...
#ifndef ROSIDL_GENERATOR_CPP__MSG__DEFAULTS__STRUCT_HPP_
#define ROSIDL_GENERATOR_CPP__MSG__DEFAULTS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__rosidl_generator_cpp__msg__Defaults __attribute__((deprecated))
#else
# define DEPRECATED__rosidl_generator_cpp__msg__Defaults __declspec(deprecated)
#endif
...
struct Defaults_
{
  ...
  // pointer types
  using RawPtr =
    rosidl_generator_cpp::msg::Defaults_<ContainerAllocator> *;
  using ConstRawPtr =
    const rosidl_generator_cpp::msg::Defaults_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<rosidl_generator_cpp::msg::Defaults_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<rosidl_generator_cpp::msg::Defaults_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      rosidl_generator_cpp::msg::Defaults_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<rosidl_generator_cpp::msg::Defaults_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<rosidl_generator_cpp::msg::Defaults_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<rosidl_generator_cpp::msg::Defaults_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<rosidl_generator_cpp::msg::Defaults_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__rosidl_generator_cpp__msg__Defaults
    std::shared_ptr<rosidl_generator_cpp::msg::Defaults_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__rosidl_generator_cpp__msg__Defaults
    std::shared_ptr<rosidl_generator_cpp::msg::Defaults_<ContainerAllocator> const>
...
using Defaults =
  rosidl_generator_cpp::msg::Defaults_<std::allocator<void>>;
...
#endif  // ROSIDL_GENERATOR_CPP__MSG__DEFAULTS__STRUCT_HPP_
