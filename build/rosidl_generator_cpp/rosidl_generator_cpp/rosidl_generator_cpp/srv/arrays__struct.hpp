...
#ifndef ROSIDL_GENERATOR_CPP__SRV__ARRAYS__STRUCT_HPP_
#define ROSIDL_GENERATOR_CPP__SRV__ARRAYS__STRUCT_HPP_
...
#include "rosidl_generator_cpp/msg/constants__struct.hpp"
// Member 'defaults_values'
#include "rosidl_generator_cpp/msg/defaults__struct.hpp"

#ifndef _WIN32
# define DEPRECATED__rosidl_generator_cpp__srv__Arrays_Request __attribute__((deprecated))
#else
# define DEPRECATED__rosidl_generator_cpp__srv__Arrays_Request __declspec(deprecated)
#endif
...
struct Arrays_Request_
{
  ...
  explicit Arrays_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      std::fill<typename std::array<uint64_t, 3>::iterator, uint64_t>(this->uint64_values.begin(), this->uint64_values.end(), 0ull);
      std::fill<typename std::array<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other>, 3>::iterator, std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other>>(this->string_values.begin(), this->string_values.end(), "");
      this->basic_types_values.fill(rosidl_generator_cpp::msg::BasicTypes_<ContainerAllocator>{_init});
      this->constants_values.fill(rosidl_generator_cpp::msg::Constants_<ContainerAllocator>{_init});
      this->defaults_values.fill(rosidl_generator_cpp::msg::Defaults_<ContainerAllocator>{_init});
    }
  }
    ...
    string_values_default(_alloc)
  {
      ...
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      std::fill<typename std::array<uint64_t, 3>::iterator, uint64_t>(this->uint64_values.begin(), this->uint64_values.end(), 0ull);
      std::fill<typename std::array<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other>, 3>::iterator, std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other>>(this->string_values.begin(), this->string_values.end(), "");
      this->basic_types_values.fill(rosidl_generator_cpp::msg::BasicTypes_<ContainerAllocator>{_alloc, _init});
      this->constants_values.fill(rosidl_generator_cpp::msg::Constants_<ContainerAllocator>{_alloc, _init});
      this->defaults_values.fill(rosidl_generator_cpp::msg::Defaults_<ContainerAllocator>{_alloc, _init});
    }
  }
  ...
  using _basic_types_values_type =
    std::array<rosidl_generator_cpp::msg::BasicTypes_<ContainerAllocator>, 3>;
  _basic_types_values_type basic_types_values;
  using _constants_values_type =
    std::array<rosidl_generator_cpp::msg::Constants_<ContainerAllocator>, 3>;
  _constants_values_type constants_values;
  using _defaults_values_type =
    std::array<rosidl_generator_cpp::msg::Defaults_<ContainerAllocator>, 3>;
  ...
  Type & set__basic_types_values(
    const std::array<rosidl_generator_cpp::msg::BasicTypes_<ContainerAllocator>, 3> & _arg)
  {
    this->basic_types_values = _arg;
    return *this;
  }
  Type & set__constants_values(
    const std::array<rosidl_generator_cpp::msg::Constants_<ContainerAllocator>, 3> & _arg)
  {
    this->constants_values = _arg;
    return *this;
  }
  Type & set__defaults_values(
    const std::array<rosidl_generator_cpp::msg::Defaults_<ContainerAllocator>, 3> & _arg)
  {
  ...
  // pointer types
  using RawPtr =
    rosidl_generator_cpp::srv::Arrays_Request_<ContainerAllocator> *;
  using ConstRawPtr =
    const rosidl_generator_cpp::srv::Arrays_Request_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<rosidl_generator_cpp::srv::Arrays_Request_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<rosidl_generator_cpp::srv::Arrays_Request_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      rosidl_generator_cpp::srv::Arrays_Request_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<rosidl_generator_cpp::srv::Arrays_Request_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<rosidl_generator_cpp::srv::Arrays_Request_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<rosidl_generator_cpp::srv::Arrays_Request_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<rosidl_generator_cpp::srv::Arrays_Request_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__rosidl_generator_cpp__srv__Arrays_Request
    std::shared_ptr<rosidl_generator_cpp::srv::Arrays_Request_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__rosidl_generator_cpp__srv__Arrays_Request
    std::shared_ptr<rosidl_generator_cpp::srv::Arrays_Request_<ContainerAllocator> const>
...
using Arrays_Request =
  rosidl_generator_cpp::srv::Arrays_Request_<std::allocator<void>>;
...
#ifndef _WIN32
# define DEPRECATED__rosidl_generator_cpp__srv__Arrays_Response __attribute__((deprecated))
#else
# define DEPRECATED__rosidl_generator_cpp__srv__Arrays_Response __declspec(deprecated)
#endif
...
struct Arrays_Response_
{
  ...
  // pointer types
  using RawPtr =
    rosidl_generator_cpp::srv::Arrays_Response_<ContainerAllocator> *;
  using ConstRawPtr =
    const rosidl_generator_cpp::srv::Arrays_Response_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<rosidl_generator_cpp::srv::Arrays_Response_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<rosidl_generator_cpp::srv::Arrays_Response_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      rosidl_generator_cpp::srv::Arrays_Response_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<rosidl_generator_cpp::srv::Arrays_Response_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      rosidl_generator_cpp::srv::Arrays_Response_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<rosidl_generator_cpp::srv::Arrays_Response_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<rosidl_generator_cpp::srv::Arrays_Response_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<rosidl_generator_cpp::srv::Arrays_Response_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__rosidl_generator_cpp__srv__Arrays_Response
    std::shared_ptr<rosidl_generator_cpp::srv::Arrays_Response_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__rosidl_generator_cpp__srv__Arrays_Response
    std::shared_ptr<rosidl_generator_cpp::srv::Arrays_Response_<ContainerAllocator> const>
...
using Arrays_Response =
  rosidl_generator_cpp::srv::Arrays_Response_<std::allocator<void>>;
...
struct Arrays
{
  using Request = rosidl_generator_cpp::srv::Arrays_Request;
  using Response = rosidl_generator_cpp::srv::Arrays_Response;
};
...
#endif  // ROSIDL_GENERATOR_CPP__SRV__ARRAYS__STRUCT_HPP_
