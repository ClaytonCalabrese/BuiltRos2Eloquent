...
#include "rosidl_generator_cpp/msg/strings__functions.h"
...
bool
rosidl_generator_cpp__msg__Strings__init(rosidl_generator_cpp__msg__Strings * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!rosidl_generator_c__String__init(&msg->string_value)) {
    rosidl_generator_cpp__msg__Strings__fini(msg);
    return false;
  }
...
void
rosidl_generator_cpp__msg__Strings__fini(rosidl_generator_cpp__msg__Strings * msg)
{
  if (!msg) {
    return;
  }
...
rosidl_generator_cpp__msg__Strings__create()
{
  rosidl_generator_cpp__msg__Strings * msg = (rosidl_generator_cpp__msg__Strings *)malloc(sizeof(rosidl_generator_cpp__msg__Strings));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosidl_generator_cpp__msg__Strings));
  bool success = rosidl_generator_cpp__msg__Strings__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
void
rosidl_generator_cpp__msg__Strings__destroy(rosidl_generator_cpp__msg__Strings * msg)
{
  if (msg) {
    rosidl_generator_cpp__msg__Strings__fini(msg);
  }
...
bool
rosidl_generator_cpp__msg__Strings__Sequence__init(rosidl_generator_cpp__msg__Strings__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rosidl_generator_cpp__msg__Strings * data = NULL;
  if (size) {
    data = (rosidl_generator_cpp__msg__Strings *)calloc(size, sizeof(rosidl_generator_cpp__msg__Strings));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosidl_generator_cpp__msg__Strings__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rosidl_generator_cpp__msg__Strings__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
void
rosidl_generator_cpp__msg__Strings__Sequence__fini(rosidl_generator_cpp__msg__Strings__Sequence * array)
{
  if (!array) {
    return;
  }
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rosidl_generator_cpp__msg__Strings__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
rosidl_generator_cpp__msg__Strings__Sequence__create(size_t size)
{
  rosidl_generator_cpp__msg__Strings__Sequence * array = (rosidl_generator_cpp__msg__Strings__Sequence *)malloc(sizeof(rosidl_generator_cpp__msg__Strings__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = rosidl_generator_cpp__msg__Strings__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
void
rosidl_generator_cpp__msg__Strings__Sequence__destroy(rosidl_generator_cpp__msg__Strings__Sequence * array)
{
  if (array) {
    rosidl_generator_cpp__msg__Strings__Sequence__fini(array);
  }
  free(array);
}
