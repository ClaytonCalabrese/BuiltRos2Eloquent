...
#ifndef ROSIDL_GENERATOR_CPP__SRV__EMPTY__FUNCTIONS_H_
#define ROSIDL_GENERATOR_CPP__SRV__EMPTY__FUNCTIONS_H_
...
#include "rosidl_generator_cpp/srv/empty__struct.h"
 ...
 * calls
 * rosidl_generator_cpp__srv__Empty_Request__init().
...
/**
 * It calls
 * rosidl_generator_cpp__srv__Empty_Request__fini()
 ...
 * rosidl_generator_cpp__srv__Empty_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rosidl_generator_cpp__srv__Empty_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rosidl_generator_cpp__srv__Empty_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rosidl_generator_cpp
...
/**
 * It calls
 * rosidl_generator_cpp__srv__Empty_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rosidl_generator_cpp
...
/**
 * It allocates the memory for the array and calls
 * rosidl_generator_cpp__srv__Empty_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rosidl_generator_cpp
...
/**
 * It calls
 * rosidl_generator_cpp__srv__Empty_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROSIDL_GENERATOR_CPP__SRV__EMPTY__FUNCTIONS_H_
