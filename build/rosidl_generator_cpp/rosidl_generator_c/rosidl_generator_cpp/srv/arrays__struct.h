...
#ifndef ROSIDL_GENERATOR_CPP__SRV__ARRAYS__STRUCT_H_
#define ROSIDL_GENERATOR_CPP__SRV__ARRAYS__STRUCT_H_
...
// Struct defined in srv/Arrays in the package rosidl_generator_cpp.
typedef struct rosidl_generator_cpp__srv__Arrays_Request
{
  bool bool_values[3];
...
// Struct for a sequence of rosidl_generator_cpp__srv__Arrays_Request.
typedef struct rosidl_generator_cpp__srv__Arrays_Request__Sequence
{
  rosidl_generator_cpp__srv__Arrays_Request * data;
...
// Struct defined in srv/Arrays in the package rosidl_generator_cpp.
typedef struct rosidl_generator_cpp__srv__Arrays_Response
{
  bool bool_values[3];
  uint8_t byte_values[3];
  uint8_t char_values[3];
...
// Struct for a sequence of rosidl_generator_cpp__srv__Arrays_Response.
typedef struct rosidl_generator_cpp__srv__Arrays_Response__Sequence
{
  rosidl_generator_cpp__srv__Arrays_Response * data;
  /// The number of valid items in data
  size_t size;
  /// The number of allocated items in data
  size_t capacity;
...
#endif  // ROSIDL_GENERATOR_CPP__SRV__ARRAYS__STRUCT_H_
