...
#include "action_msgs/msg/goal_status_array__rosidl_typesupport_fastrtps_c.h"
...
#include "action_msgs/msg/goal_status__functions.h"  // status_list
...
{
  return max_serialized_size_action_msgs__msg__GoalStatusArray(
    full_bounded, 0);
}
