...
: ${AMENT_CURRENT_PREFIX:="/opt/workspace/install/yaml_cpp_vendor"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/yaml_cpp_vendor/environment/yaml_cpp_vendor_library_path.sh"
