...
#include "visualization_msgs/msg/marker__rosidl_typesupport_fastrtps_c.h"
...
#include "builtin_interfaces/msg/duration__functions.h"  // lifetime
#include "geometry_msgs/msg/point__functions.h"  // points
#include "geometry_msgs/msg/pose__functions.h"  // pose
#include "geometry_msgs/msg/vector3__functions.h"  // scale
#include "rosidl_generator_c/string.h"  // mesh_resource, ns, text
#include "rosidl_generator_c/string_functions.h"  // mesh_resource, ns, text
#include "std_msgs/msg/color_rgba__functions.h"  // color, colors
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: ns
  {
    const rosidl_generator_c__String * str = &ros_message->ns;
  ...
  // Field name: text
  {
    const rosidl_generator_c__String * str = &ros_message->text;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->mesh_resource;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: ns
  {
    ...
    if (!ros_message->ns.data) {
      rosidl_generator_c__String__init(&ros_message->ns);
    }
  ...
  // Field name: text
  {
    ...
    if (!ros_message->text.data) {
      rosidl_generator_c__String__init(&ros_message->text);
    }
    bool succeeded = rosidl_generator_c__String__assign(
      &ros_message->text,
      tmp.c_str());
  ...
  // Field name: mesh_resource
  {
    ...
    if (!ros_message->mesh_resource.data) {
      rosidl_generator_c__String__init(&ros_message->mesh_resource);
    }
    bool succeeded = rosidl_generator_c__String__assign(
