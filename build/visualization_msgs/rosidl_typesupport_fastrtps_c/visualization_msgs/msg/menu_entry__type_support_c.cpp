...
#include "visualization_msgs/msg/menu_entry__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/string.h"  // command, title
#include "rosidl_generator_c/string_functions.h"  // command, title
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: title
  {
    const rosidl_generator_c__String * str = &ros_message->title;
  ...
  // Field name: command
  {
    const rosidl_generator_c__String * str = &ros_message->command;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  _MenuEntry__ros_msg_type * ros_message = static_cast<_MenuEntry__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr >> ros_message->id;
  }
  ...
  // Field name: title
  {
    ...
    if (!ros_message->title.data) {
      rosidl_generator_c__String__init(&ros_message->title);
    }
  ...
  // Field name: command
  {
    ...
    if (!ros_message->command.data) {
      rosidl_generator_c__String__init(&ros_message->command);
    }
    bool succeeded = rosidl_generator_c__String__assign(
      &ros_message->command,
      tmp.c_str());
...
static size_t _MenuEntry__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_visualization_msgs__msg__MenuEntry(
    full_bounded, 0);
}
