...
#include "visualization_msgs/msg/interactive_marker_feedback__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/point__functions.h"  // mouse_point
#include "geometry_msgs/msg/pose__functions.h"  // pose
#include "rosidl_generator_c/string.h"  // client_id, control_name, marker_name
#include "rosidl_generator_c/string_functions.h"  // client_id, control_name, marker_name
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->client_id;
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->marker_name;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->control_name;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: client_id
  {
    ...
    if (!ros_message->client_id.data) {
      rosidl_generator_c__String__init(&ros_message->client_id);
    }
  ...
  // Field name: marker_name
  {
    ...
    if (!ros_message->marker_name.data) {
      rosidl_generator_c__String__init(&ros_message->marker_name);
    }
    bool succeeded = rosidl_generator_c__String__assign(
  ...
  // Field name: control_name
  {
    ...
    if (!ros_message->control_name.data) {
      rosidl_generator_c__String__init(&ros_message->control_name);
    }
    bool succeeded = rosidl_generator_c__String__assign(
...
static size_t _InteractiveMarkerFeedback__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_visualization_msgs__msg__InteractiveMarkerFeedback(
    full_bounded, 0);
}
