...
#include "visualization_msgs/msg/interactive_marker_update__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/string.h"  // erases, server_id
#include "rosidl_generator_c/string_functions.h"  // erases, server_id
#include "visualization_msgs/msg/interactive_marker__functions.h"  // markers
#include "visualization_msgs/msg/interactive_marker_pose__functions.h"  // poses
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->server_id;
  ...
  void * untyped_ros_message)
{
  ...
  _InteractiveMarkerUpdate__ros_msg_type * ros_message = static_cast<_InteractiveMarkerUpdate__ros_msg_type *>(untyped_ros_message);
  // Field name: server_id
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->server_id.data) {
      rosidl_generator_c__String__init(&ros_message->server_id);
    }
  ...
  // Field name: erases
  {
    ...
    if (ros_message->erases.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->erases);
    }
    if (!rosidl_generator_c__String__Sequence__init(&ros_message->erases, size)) {
      return "failed to create array for field 'erases'";
    }
    auto array_ptr = ros_message->erases.data;
    for (size_t i = 0; i < size; ++i) {
      std::string tmp;
...
{
  return max_serialized_size_visualization_msgs__msg__InteractiveMarkerUpdate(
    full_bounded, 0);
}
