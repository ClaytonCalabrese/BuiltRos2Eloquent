...
#include "visualization_msgs/msg/interactive_marker__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/string.h"  // description, name
#include "rosidl_generator_c/string_functions.h"  // description, name
#include "std_msgs/msg/header__functions.h"  // header
#include "visualization_msgs/msg/interactive_marker_control__functions.h"  // controls
#include "visualization_msgs/msg/menu_entry__functions.h"  // menu_entries
  ...
  void * untyped_ros_message)
{
  ...
  _InteractiveMarker__ros_msg_type * ros_message = static_cast<_InteractiveMarker__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: menu_entries
  {
    ...
    if (!visualization_msgs__msg__MenuEntry__Sequence__init(&ros_message->menu_entries, size)) {
      return "failed to create array for field 'menu_entries'";
    }
    auto array_ptr = ros_message->menu_entries.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
...
{
  return max_serialized_size_visualization_msgs__msg__InteractiveMarker(
    full_bounded, 0);
}
