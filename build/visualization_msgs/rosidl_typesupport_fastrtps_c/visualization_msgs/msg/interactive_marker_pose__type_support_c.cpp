...
#include "visualization_msgs/msg/interactive_marker_pose__rosidl_typesupport_fastrtps_c.h"
...
using _InteractiveMarkerPose__ros_msg_type = visualization_msgs__msg__InteractiveMarkerPose;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _InteractiveMarkerPose__ros_msg_type * ros_message = static_cast<const _InteractiveMarkerPose__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _InteractiveMarkerPose__ros_msg_type * ros_message = static_cast<_InteractiveMarkerPose__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static size_t _InteractiveMarkerPose__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_visualization_msgs__msg__InteractiveMarkerPose(
    full_bounded, 0);
}
