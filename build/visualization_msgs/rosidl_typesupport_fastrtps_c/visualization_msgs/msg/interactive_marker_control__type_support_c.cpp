...
#include "visualization_msgs/msg/interactive_marker_control__rosidl_typesupport_fastrtps_c.h"
...
#include "visualization_msgs/msg/marker__functions.h"  // markers
  ...
  void * untyped_ros_message)
{
  ...
  _InteractiveMarkerControl__ros_msg_type * ros_message = static_cast<_InteractiveMarkerControl__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
    std::string tmp;
    cdr >> tmp;
...
{
  return max_serialized_size_visualization_msgs__msg__InteractiveMarkerControl(
    full_bounded, 0);
}
