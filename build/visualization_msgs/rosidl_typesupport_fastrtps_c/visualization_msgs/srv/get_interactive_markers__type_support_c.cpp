...
#include "visualization_msgs/srv/get_interactive_markers__rosidl_typesupport_fastrtps_c.h"
...
{
  return max_serialized_size_visualization_msgs__srv__GetInteractiveMarkers_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_visualization_msgs__srv__GetInteractiveMarkers_Response(
    full_bounded, 0);
}
