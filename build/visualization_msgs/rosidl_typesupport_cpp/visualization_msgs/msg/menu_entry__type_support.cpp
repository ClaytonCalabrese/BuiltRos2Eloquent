...
static const _MenuEntry_type_support_symbol_names_t _MenuEntry_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, visualization_msgs, msg, MenuEntry)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, visualization_msgs, msg, MenuEntry)),
  }
};
...
{
  return &::visualization_msgs::msg::rosidl_typesupport_cpp::MenuEntry_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, visualization_msgs, msg, MenuEntry)() {
  return get_message_type_support_handle<visualization_msgs::msg::MenuEntry>();
}
