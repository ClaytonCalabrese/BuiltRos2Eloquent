...
class MoveBase_SendGoal_Request(metaclass=Metaclass_MoveBase_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'move_base_msgs/MoveBase_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['move_base_msgs', 'action'], 'MoveBase_Goal'),  # noqa: E501
    )
...
class Metaclass_MoveBase_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'move_base_msgs.action.MoveBase_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveBase_SendGoal(metaclass=Metaclass_MoveBase_SendGoal):
    from move_base_msgs.action._move_base import MoveBase_SendGoal_Request as Request
    from move_base_msgs.action._move_base import MoveBase_SendGoal_Response as Response
...
class MoveBase_GetResult_Response(metaclass=Metaclass_MoveBase_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'move_base_msgs/MoveBase_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['move_base_msgs', 'action'], 'MoveBase_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from move_base_msgs.action._move_base import MoveBase_Result
...
class MoveBase_GetResult(metaclass=Metaclass_MoveBase_GetResult):
    from move_base_msgs.action._move_base import MoveBase_GetResult_Request as Request
    from move_base_msgs.action._move_base import MoveBase_GetResult_Response as Response
...
class Metaclass_MoveBase_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'move_base_msgs.action.MoveBase_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveBase_FeedbackMessage(metaclass=Metaclass_MoveBase_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'move_base_msgs/MoveBase_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['move_base_msgs', 'action'], 'MoveBase_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from move_base_msgs.action._move_base import MoveBase_Feedback
...
class MoveBase(metaclass=Metaclass_MoveBase):
    ...
    from move_base_msgs.action._move_base import MoveBase_Goal as Goal
    # The result message defined in the action definition.
    from move_base_msgs.action._move_base import MoveBase_Result as Result
    # The feedback message defined in the action definition.
    from move_base_msgs.action._move_base import MoveBase_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from move_base_msgs.action._move_base import MoveBase_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from move_base_msgs.action._move_base import MoveBase_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from move_base_msgs.action._move_base import MoveBase_FeedbackMessage as FeedbackMessage
