...
#include "geometry_msgs/msg/pose_array__rosidl_typesupport_fastrtps_c.h"
...
static size_t _PoseArray__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_geometry_msgs__msg__PoseArray(
    full_bounded, 0);
}
