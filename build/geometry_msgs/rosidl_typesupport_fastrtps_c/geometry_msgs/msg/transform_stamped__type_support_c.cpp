...
#include "geometry_msgs/msg/transform_stamped__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/transform__functions.h"  // transform
#include "rosidl_generator_c/string.h"  // child_frame_id
#include "rosidl_generator_c/string_functions.h"  // child_frame_id
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->child_frame_id;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: child_frame_id
  {
    ...
    if (!ros_message->child_frame_id.data) {
      rosidl_generator_c__String__init(&ros_message->child_frame_id);
    }
...
static size_t _TransformStamped__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_geometry_msgs__msg__TransformStamped(
    full_bounded, 0);
}
