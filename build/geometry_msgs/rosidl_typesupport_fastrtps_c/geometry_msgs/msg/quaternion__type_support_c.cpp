...
#include "geometry_msgs/msg/quaternion__rosidl_typesupport_fastrtps_c.h"
...
static size_t _Quaternion__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_geometry_msgs__msg__Quaternion(
    full_bounded, 0);
}
