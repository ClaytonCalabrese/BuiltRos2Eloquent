...
#include "geometry_msgs/msg/transform__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/vector3__functions.h"  // translation
...
{
  return max_serialized_size_geometry_msgs__msg__Transform(
    full_bounded, 0);
}
