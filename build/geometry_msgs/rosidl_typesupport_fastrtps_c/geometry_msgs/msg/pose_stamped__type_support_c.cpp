...
#include "geometry_msgs/msg/pose_stamped__rosidl_typesupport_fastrtps_c.h"
...
static size_t _PoseStamped__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_geometry_msgs__msg__PoseStamped(
    full_bounded, 0);
}
