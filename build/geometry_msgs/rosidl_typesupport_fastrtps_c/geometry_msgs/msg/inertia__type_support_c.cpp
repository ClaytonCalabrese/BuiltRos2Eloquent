...
#include "geometry_msgs/msg/inertia__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/vector3__functions.h"  // com
...
{
  return max_serialized_size_geometry_msgs__msg__Inertia(
    full_bounded, 0);
}
