...
#include "geometry_msgs/msg/pose__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/point__functions.h"  // position
...
{
  return max_serialized_size_geometry_msgs__msg__Pose(
    full_bounded, 0);
}
