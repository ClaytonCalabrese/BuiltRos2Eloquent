...
#include "geometry_msgs/msg/twist__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/vector3__functions.h"  // angular, linear
...
{
  return max_serialized_size_geometry_msgs__msg__Twist(
    full_bounded, 0);
}
