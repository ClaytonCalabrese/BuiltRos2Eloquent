...
#include "geometry_msgs/msg/accel_with_covariance_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  return max_serialized_size_AccelWithCovarianceStamped(full_bounded, 0);
}
