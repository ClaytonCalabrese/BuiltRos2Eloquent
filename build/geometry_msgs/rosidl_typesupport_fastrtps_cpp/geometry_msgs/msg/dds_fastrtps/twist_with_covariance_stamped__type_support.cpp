...
#include "geometry_msgs/msg/twist_with_covariance_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  return max_serialized_size_TwistWithCovarianceStamped(full_bounded, 0);
}
