...
: ${AMENT_CURRENT_PREFIX:="/opt/workspace/install/libcurl_vendor"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/libcurl_vendor/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/libcurl_vendor/environment/libcurl_vendor_library_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/libcurl_vendor/environment/path.sh"
