...
#ifndef RQT_PY_COMMON__MSG__VAL__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
#define RQT_PY_COMMON__MSG__VAL__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
...
#endif  // RQT_PY_COMMON__MSG__VAL__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
