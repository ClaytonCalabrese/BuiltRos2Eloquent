...
class Metaclass_AddTwoInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rqt_py_common.srv import _add_two_ints
...
class AddTwoInts(metaclass=Metaclass_AddTwoInts):
    from rqt_py_common.srv._add_two_ints import AddTwoInts_Request as Request
    from rqt_py_common.srv._add_two_ints import AddTwoInts_Response as Response
