...
: ${AMENT_CURRENT_PREFIX:="/opt/workspace/install/cyclonedds_cmake_module"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cyclonedds_cmake_module/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cyclonedds_cmake_module/environment/path.sh"
