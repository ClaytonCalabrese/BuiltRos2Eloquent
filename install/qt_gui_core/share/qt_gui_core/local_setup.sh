...
: ${AMENT_CURRENT_PREFIX:="/opt/workspace/install/qt_gui_core"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/qt_gui_core/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/qt_gui_core/environment/path.sh"
