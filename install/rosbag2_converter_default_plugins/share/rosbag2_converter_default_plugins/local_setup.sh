...
: ${AMENT_CURRENT_PREFIX:="/opt/workspace/install/rosbag2_converter_default_plugins"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rosbag2_converter_default_plugins/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rosbag2_converter_default_plugins/environment/path.sh"
