...
: ${AMENT_CURRENT_PREFIX:="/opt/workspace/install/rosbag2_transport"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rosbag2_transport/environment/pythonpath.sh"
