...
: ${AMENT_CURRENT_PREFIX:="/opt/workspace/install/rosbag2"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rosbag2/environment/library_path.sh"
