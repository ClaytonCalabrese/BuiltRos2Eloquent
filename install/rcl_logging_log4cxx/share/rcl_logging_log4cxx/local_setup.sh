...
: ${AMENT_CURRENT_PREFIX:="/opt/workspace/install/rcl_logging_log4cxx"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rcl_logging_log4cxx/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rcl_logging_log4cxx/environment/library_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rcl_logging_log4cxx/environment/path.sh"
